...
//------------------------------------------------------------------------------------------------------------+
	...
	function lgsl_type_list()
	{
		...
		"multitheftauto"	=> "Multi Theft Auto",
...
//------------------------------------------------------------------------------------------------------------+
	...
	function lgsl_software_link($type, $ip, $c_port, $q_port, $s_port)
	{
		...
		"multitheftauto"	=> "mtasa://{IP}:{C_PORT}",
...
//------------------------------------------------------------------------------------------------------------+
	...
	function lgsl_port_conversion($type, $c_port, $q_port, $s_port)
	{
		switch ($type) // GAMES WHERE Q_PORT IS NOT EQUAL TO C_PORT
		{
			...
			case "multitheftauto"	: $c_to_q = 123;	$c_def = 22003;	$q_def = 22126;	$c_to_s = 0;	break;
...
//------------------------------------------------------------------------------------------------------------+
	...
	//---------------------------------------------------------+
		...
		while ($buffer)
		{
			...
			elseif ($server['b']['type'] == "multitheftauto")		{ $field_list = array("name", "",	  "",	 "score", "ping", ""	); }
