...
define('redirecting_in', "Weiterleitung");
...
define('solve_captcha', "Menschlichkeitsprüfung");
...
define('remove_install', "Bitte lösche die install.php aus Sicherheitsgründen.");
...
define('unable_to_load_xml', "Konnte XML Datei '%s' nicht laden. Rechteproblem?");
...
define('sub_users', "Subbenutzer");
define('show_groups', "Gruppen");
define('user_games', "Gameserver");
define('addons_manager', "Addonmanager");
...
define('show_version', "Version anzeigen");
define('queries_executed', "Abfragen durchgeführt");
define('lang', "Sprache");
define('get_size', "Zeige Größe");
define('total_size', "Gesamtgröße");
define('lgsl', "LGSL");
define('lgsl_admin', "LGSL Admin");
define('rcon', "RCON");
define('watch_logger', "Watch Logger");
define('litefm_settings', "LiteFM Einstellungen");
define('assign_expiration_date', "Ablaufdatum zuweisen");
define('assign_expiration_date_info', "Wenn der Server abläuft wird er vom derzeitigen Benutzer entfernt aber nicht gelöscht.");
define('server_expiration_date', "Server Ablaufdatum");
define('server_expiration_date_info', "Wenn der Server abläuft wird er entfernt (Datenbank und Dateien).");
define('set_expiration_date', "Ablaufdatum setzen");
define('admin_dsi', "DSi Einstellungen");
define('user_dsi', "DSi");
define('list_dsi', "DSi Liste");
define('no_remote_servers', "Es gibt keine bekannten Remoteserver! Fügen Sie einen Server zur Verwendung dieser Funktion hinzu.");
define('no_results_found', "Keine Suchergebnisse für '%s' gefunden");
