...
define('lang', "Sprache");
define('get_size', "Größe ermitteln");
...
define('assign_expiration_date', "Ablaufdatum setzen");
define('assign_expiration_date_info', "Wenn der Server abläuft ist er nicht mehr zugeordnet aber nicht gelöscht");
define('server_expiration_date', "Server Ablaufdatum");
define('server_expiration_date_info', "Wenn der Server abläuft wird er vollständig gelöscht.");
