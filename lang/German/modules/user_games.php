...
define('OGP_LANG_no_remote_servers_configured', "Es wurde kein Agent für OpenGamePanel eingerichtet.
Du benötigst eine Agent Verbindung bevor ein dem Benutzer ein Server hinzugefügt werden kann.");
define('OGP_LANG_no_game_configurations_found', "Keine Spielkonfiguration gefunden. Du musste eine Spielkonfiguration hinzufügen von");
...
define('OGP_LANG_game_server_name', "Spielserver Name");
define('OGP_LANG_change_name_info', "Der Name des Servers hilft Benutzern ihn zu finden.");
...
define('OGP_LANG_note_no_mods', "Keine Erweiterung(en) für dieses Spiel.");
...
define('OGP_LANG_extra_cmd_line_args', "Zusätzliche Kommandozeilen Argumente");
define('OGP_LANG_extra_cmd_line_info', "Die zusätzlichen Kommandozeilen Argumente ermöglichen weitere Befehle beim Start.");
...
define('OGP_LANG_successfully_modified_mod', "Modinformationen erfolgreich angewendet.");
...
define('OGP_LANG_change_user_id_main_info', "Hauptserver Besitzer");
...
define('OGP_LANG_successfully_changed_game_server', "Spielserver erfolgreich geändert.");
...
define('OGP_LANG_invalid_home_id_entered', "Unzulässige HomeID angegeben.");
...
define('OGP_LANG_successfully_removed_mod', "Spieleerweiterung erfolgreich entfernt.");
...
define('OGP_LANG_set_as_master_server', "Setze als Hauptserver");
...
define('OGP_LANG_add_new_game_home', "Neuen Spieleserver hinzufügen");
...
define('OGP_LANG_agent_ip', "IP des Agent");
