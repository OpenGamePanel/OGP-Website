...
define('OGP_LANG_charset_info', "UTF8, ISO, ASCII, etc . Überschreibt die in Sprachdateien definierte Zeichenkodierung. Lassen Sie das Feld leer, um die Standardsprache zu verwenden.");
