...
define('maintenance_mode_info', "Die Meldung, die normale Benutzer während der Wartung angezeigt wird.");
...
define('settings_updated', "Einstellungen erfolgreich gespeichert.");
define('panel_language', "Panel Sprache");
define('panel_language_info', "Diese Sprache ist die Standardsprache des Panels. Benutzer können ihre eigene Sprache setzen.");
define('page_auto_refresh', "Automatische Aktualisierung");
define('page_auto_refresh_info', "Page Auto-Refresh-Einstellungen wird hauptsächlich im Panel-Debugging verwendet. Im Normalbetrieb sollte dies auf Ein eingestellt sein");
define('smtp_server', "Ausgehender E-Mail Server");
define('smtp_server_info', "Dies ist der Postausgangsserver (SMTP-Server), der zum Beispiel verwendet wird, um vergessene Passwörter an Benutzer zu senden, standardmäßig localhost.");
define('panel_email_address', "Ausgehende E-Mail Adresse");
define('panel_email_address_info', "Dies ist die Absender E-Mail-Adresse wenn Kennwörter an Benutzer gesendet werden.");
define('panel_name', "Panel Name");
define('panel_name_info', "Name des Bedienfelds, das im Seitentitel angezeigt wird. Dieser Wert überschreibt alle Seitentitel wenn nicht leer.");
