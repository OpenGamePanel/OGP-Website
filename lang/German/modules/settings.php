...
define('OGP_LANG_custom_github_update_branch_name_info', "Geben Sie den Namen des Branch ein, den Sie für die Aktualisierung von OGP verwenden möchten. Dies sollte nur von Entwicklern geändert werden, die ihre eigenen Repos für die Entwicklung verwenden möchten, anstatt möglicherweise fehlerhaften Code in den Hauptbranch zu übertragen.&nbsp; Lassen Sie dieses Feld leer, um als Standardwert \"master\" zu verwenden.");
...
define('OGP_LANG_use_authorized_hosts', "API auf definierte autorisierte Hosts beschränken");
define('OGP_LANG_use_authorized_hosts_info', "Aktivieren Sie diese Einstellung, um nur API-Aufrufe von vordefinierten und zugelassenen IP-Adressen aus zu ermöglichen.&nbsp; Zugelassene Adressen können auf dieser Seite festgelegt werden, sobald die Einstellung aktiviert wurde.&nbsp; Wenn diese Einstellung deaktiviert ist, hat ein Benutzer mit einem gültigen API-Key von jeder IP-Adresse aus Zugriff auf die API.&nbsp; Benutzer mit einem gültigen API-Key können die API verwenden, um jeden Spieleserver zu verwalten, für den sie eine Verwaltungsberechtigung besitzen.");
define('OGP_LANG_allow_setting_cpu_affinity', "Einstellung der CPU-Kernzuweisung für Gameserver zulassen");
define('OGP_LANG_allow_setting_cpu_affinity_info', "Wenn diese Option aktiviert ist, werden dem Administrator, der eine Startumgebung erstellt, CPU-Affinitätsoptionen (Kernzuweisung) für den Spieleserver angezeigt.");
...
define('OGP_LANG_reset_game_server_order', "Server-Bestellung zurücksetzen");
define('OGP_LANG_reset_game_server_order_info', "Setzt die Server-Bestellung auf die Standardeinstellung zurück, die die Server-ID verwendet.");
define('OGP_LANG_regex_invalid_file_name_chars', "Ungültige Zeichen im Dateinamen Regex");
define('OGP_LANG_regex_invalid_file_name_chars_info', "Ändern Sie dieses regex Muster, wenn Sie andere Zeichen in Dateinamen zulassen wollen.");
define('OGP_LANG_login_ban_time', "Anmeldung fehlgeschlagen, Ihr Konto wurde für (Seconds) gesperrt");
define('OGP_LANG_login_ban_time_info', "Zeit in Sekunden, in der eine IP-Adresse nach einer bestimmten Anzahl von fehlgeschlagenen Anmeldeversuchen nicht mehr in das Panel eingeloggt werden darf.");
?>
