...
define('install_config', "Installiere Konfigurationen");
define('game_name', "Spielname");
define('directory', "Verzeichnispfad");
define('remote_server', "Remote Server");
define('select_addon', "Wähle Addon");
define('install', "Installieren");
define('failed_to_start_file_download', "Fehler beim starten des Datei-Downloads.");
define('no_games_servers_available', "Es sind keine Gameserver in deinem Konto verfügbar.");
define('addon_installed_successfully', "Addon erfolgreich installiert");
define('path', "Pfad");
define('wait_while_decompressing', "Warten Sie, bis die Datei %s dekomprimiert ist.");
