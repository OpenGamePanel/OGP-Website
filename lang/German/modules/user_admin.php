...
define('page_limit_info', "Anzahl der Items die pro Seite angezeigt werden. Die Nummer kann nicht kleiner als 10 sein.");
...
define('theme', "Thema");
define('theme_info', "Wenn Theme leer ist, wird der globale Wert verwendet.");
define('expires_info', "Datum, an dem das Benutzerkonto abläuft. Das Konto wird nicht gelöscht, aber der Benutzer kann sich nicht mehr einloggen.");
...
define('current_password_mismatch', "Ihr aktuelles Passwort stimmt nicht mit dem in der Datenbank überein.");
define('add_new_user', "Neuen Benutzer hinzufügen");
define('edit_user_groups', "Benutzergruppen bearbeiten");
define('users', "Benutzer");
define('user_role', "Rolle");
define('full_name', "Vollständiger Name");
define('edit_games', "Spiele bearbeiten");
define('edit_profile', "Profil bearbeiten");
define('confirm_password', "Passwort wiederholen");
define('you_need_to_enter_both_passwords', "Sie müssen beide Passwörter eingeben.");
define('passwords_did_not_match', "Die Passwörter stimmen nicht überein.");
define('could_not_add_user_because_user_already_exists', "Benutzer konnte nicht hinzugefügt werden, da Benutzer <em> %s </em> bereits vorhanden ist.");
define('successfully_added_user', "Successfully added user <em>%s</em>.");
define('add_a_new_user', "Einen neuen Benutzer hinzufügen");
define('admin', "Admin");
