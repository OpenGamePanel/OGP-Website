...
define('OGP_LANG_confirm_reboot', "Möchten Sie wirklich den gesamten physischen Server mit dem Namen '%s neu starten ?");
define('OGP_LANG_confirm_restart', "Sind Sie sicher das Sie den folgenden Agent neu starten möchten '%s'?");
...
Sie können nicht auf den Server zugreifen, bis er erfolgreich gebootet wurde.");
...
define('OGP_LANG_error_while_remove', "Fehler beim entfernen des entfernten Servers.");
