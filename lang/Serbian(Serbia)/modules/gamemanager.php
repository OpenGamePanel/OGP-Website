...
define('OGP_LANG_install_update_steam', "Инсталирај/Ажурирај преко стима");
define('OGP_LANG_install_update_manual', "Инсталирај/Ажурирај ручно");
define('OGP_LANG_assign_game_homes', "Додели сервере");
define('OGP_LANG_user', "Корисник");
define('OGP_LANG_group', "Група");
define('OGP_LANG_start', "Покрени");
define('OGP_LANG_ogp_agent_ip', "OGP Агент IP");
define('OGP_LANG_max_players', "Максимално играча");
define('OGP_LANG_max', "Максимално");
define('OGP_LANG_ip_and_port', "IP и порт");
define('OGP_LANG_available_maps', "Доступне мапе");
define('OGP_LANG_map_path', "Путања до мапе");
define('OGP_LANG_available_parameters', "Доступни параметри");
define('OGP_LANG_start_server', "Покрени сервер");
define('OGP_LANG_start_wait_note', "Покретање сервера ће можда потрајати. Молимо вас да не затварате претраживач и сачекате.");
define('OGP_LANG_game_type', "Тип игре");
define('OGP_LANG_map', "Мапа");
define('OGP_LANG_starting_server', "Покретање сервера, молимо сачекајте...");
define('OGP_LANG_starting_server_settings', "Покретање сервера са следећим подешавањима");
define('OGP_LANG_startup_params', "Параметри за покретање");
