...
define('OGP_LANG_install_welcome', "Velkommen til Open Game Panel Setup");
...
define('OGP_LANG_default_welcome_title_message', "Velkommen! <b style='font-size:12px; font-weight:normal;'>Du ka ændre denne titel i '<a href='?m=settings&p=themes'>Theme Settings</a>' under '<a href='?m=administration&p=main'>Administration</a>' tab.</b>");
?>