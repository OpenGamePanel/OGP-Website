...
define('OGP_LANG_dir_not_found', "Mappen '%s' blev ikke fundet.");
define('OGP_LANG_filename', "Filnavn");
define('OGP_LANG_filesize', "Filstørrelse");
define('OGP_LANG_bytes', "Bytes");
define('OGP_LANG_owner', "Ejer");
define('OGP_LANG_group', "Gruppe");
define('OGP_LANG_empty_directory', "Mappen er tom.");
define('OGP_LANG_currently_viewing', "Nuværrende mappe fremvisning '%s'");
define('OGP_LANG_wrote_changes', "Skrev ændringerne succesfuldt.");
define('OGP_LANG_failed_write', "Fejlet i at skrive til fjern-server.");
define('OGP_LANG_failed_read', "Fejlet i at læse fil fra fjern-server.");
define('OGP_LANG_failed_list', "Fejlet i at modtage mappe liste.");
define('OGP_LANG_level_up', "^Op en Level^");
define('OGP_LANG_unallowed_char', "Ikke tilladt karaktere fundet fra mappe sti.");
define('OGP_LANG_button_edit', "[Redigere]");
define('OGP_LANG_save', "Gem");
define('OGP_LANG_home_id_missing', "Hjemme ID mangler.");
define('OGP_LANG_upload', "Upload");
define('OGP_LANG_upload_failed', "Upload fejlet, fejlen var: %s.");
define('OGP_LANG_can_not_create_upload_folder_path', "Kan ikke bygge mappe sti %s");
define('OGP_LANG_url_is_not_accesible_from_agent', "URL %s is not accessible from the Agent");
define('OGP_LANG_upload_file', "Upload fil");
define('OGP_LANG_uncompress', "Udpakning");
define('OGP_LANG_create_folder', "Oprette mappe");
define('OGP_LANG_create', "Opret");
define('OGP_LANG_delete_item', "Slet %s?");
define('OGP_LANG_upload_in_progress', "Upload bliver bearbejdet...");
define('OGP_LANG_upload_complete', "Upload Færdig.");
