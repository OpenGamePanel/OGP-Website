...
define('any_server_is_online', "Hvilken som helst server er Online");
...
define('no_games_to_monitor', "Der er på nuværrende tidspunkt ingen online/offline spille servere");
