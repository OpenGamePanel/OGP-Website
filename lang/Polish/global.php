...
define('login', "Nazwa użytkownika");
define('login_button', "Zaloguj");
define('solve_captcha', "Sprawdzanie Botów");
...
define('db_error_module_missing', "Brak wymaganego modułu PHP.");
define('db_error_invalid_db_type', "Nieprawidłowy typ bazy danych w pliku konfiguracyjnym.");
...
define('xml_file_not_valid', "Plik XML '%s' nie może zostać zweryfikowany przez schemat '%s'.");
define('unable_to_load_xml', "Nie można wczytać pliku XML '%s'. Błąd dostępu?");
...
define('all_rights_reserved', "Wszelkie prawa zastrzeżone");
define('version', "Wersja");
define('show_version', "Pokaż Wersję");
define('queries_executed', "wykonanych zapytań");
define('lang', "Język");
...
define('server_expiration_date', "Data wygaśnięcia serwera");
define('server_expiration_date_info', "Po wygaśnięciu serwera zostanie usunięty (wszystkie pliki oraz z bazy danych).");
define('set_expiration_date', "Ustaw datę wygaśnięcia");
define('admin_dsi', "Ustawienia DSi");
define('user_dsi', "DSi");
define('list_dsi', "Lista DSi");
define('no_remote_servers', "Nie ma znanych serwerów zdalnych! Dodać serwer do korzystania z tej funkcji.");
