...
define('err_captcha', "Nieprawidłowe kod Captcha.");
...
define('err_users_parent', "Konto Subuser nie może tworzyć innych użytkowników.");
define('err_parent_user', "ID użytkownika nadrzędnego musi odwoływać się do AKTYWNEGO użytkownika istniejącego.");
