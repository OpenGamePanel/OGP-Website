...
define('login_attempts_before_banned', "Liczba nieudanych prób zalogowania się zanim użytkownik zostanie zbanowany");
define('login_attempts_before_banned_info', "Jeśli użytkownik próbuje wielokrotnie logować się z nieprawidłowymi poświadczeniami, tymczasowo zostanie zbanowany przez panel.");
