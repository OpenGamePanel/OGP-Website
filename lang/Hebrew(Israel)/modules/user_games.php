...
define('OGP_LANG_add_mods_note', "עליך להוסיף מודים אחרי הוספת השרת למשתמש.
ניתן לעשות זאת על ידי עריכת השרת.");
define('OGP_LANG_game_servers', "שרתי משחק");
define('OGP_LANG_game_path', "נתיב משחק");
define('OGP_LANG_game_path_info', "An absolute server path. Example: /home/ogpbot/OGP_User_Files/My_Server");
define('OGP_LANG_game_server_name_info', "שם השרת עוזר למשתמשים לזהות את השרתים שלהם.");
define('OGP_LANG_control_password', "סיסמת שליטה/בקרה");
define('OGP_LANG_control_password_info', "סיסמה זו משמשת לבקרת שרתים, כגון סיסמת RCON. אם הסיסמה ריקה, משתמשים באמצעים אחרים.");
define('OGP_LANG_add_game_home', "הוסף שרת משחק");
define('OGP_LANG_game_path_empty', "נתיב המשחק אינו יכול להיות ריק.");
define('OGP_LANG_game_home_added', "שרת המשחק הוסף בהצלחה. מפנה לדף העריכה הביתי.");
...
define('OGP_LANG_add_remote_server', "הוסף שרת.");
...
define('OGP_LANG_game_server_name', "שם שרת המשחק");
...
define('OGP_LANG_available_mods', "מודים זמינים");
define('OGP_LANG_note_no_mods', "אין מודים() זמינים עבור משחק זה.");
define('OGP_LANG_change_home', "שנה בית");
define('OGP_LANG_change_control_password', "שנה סיסמאת בקרה");
define('OGP_LANG_change_name', "שנה שם");
define('OGP_LANG_add_mod', "הוסף מוד");
define('OGP_LANG_set_ip', "הגדר אייפי");
define('OGP_LANG_ips_and_ports', "אייפי ופורטים");
define('OGP_LANG_mod_name', "שם המוד");
define('OGP_LANG_max_players', "מקסימות שחקנים");
...
define('OGP_LANG_cpu_affinity', "זיקת המעבד");
define('OGP_LANG_nice_level', "רמת 'נחמדות'");
define('OGP_LANG_set_options', "הגדר אפשרויות");
define('OGP_LANG_remove_mod', "הסר מוד");
define('OGP_LANG_mods', "מודים");
...
define('OGP_LANG_back_to_game_monitor', "חזור אל צג המשחק");
define('OGP_LANG_back_to_game_servers', "חזרה לשרתי משחק");
define('OGP_LANG_user_id_main', "בעלים ראשי");
define('OGP_LANG_change_user_id_main', "שנה בעלים ראשי");
define('OGP_LANG_change_user_id_main_info', "The main server home owner.");
define('OGP_LANG_server_ftp_password', "סיסמת FTP");
define('OGP_LANG_change_ftp_password', "שנה סיסמת FTP");
...
define('OGP_LANG_control_password_updated_successfully', "סיסמת הבקרה עודכנה בהצלחה.");
define('OGP_LANG_control_password_update_failed', "עדכון סיסמת הבקרה נכשלה");
define('OGP_LANG_successfully_changed_game_server', "השינוי בשרת משחק הושלם בהצלחה");
define('OGP_LANG_error_ocurred_on_remote_server', "Error ocurred on remote server,");
define('OGP_LANG_ftp_password_can_not_be_changed', "לא ניתן לשנות את סיסמת הFTP.");
