...
define('OGP_LANG_resetting_configs', "Kaikkien määrityksien nollaaminen");
...
define('OGP_LANG_delete_game_config_for', "Poista pelin %s määritykset levyltä ja tietokannasta.");
?>