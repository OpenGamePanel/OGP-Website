...
define('OGP_LANG_ftp_address', "FTP-osoite %s:%s");
define('OGP_LANG_change_account_details', "Muuta tilin tietoja");
define('OGP_LANG_remove_account', "Poista tili");
define('OGP_LANG_ftp_account_already_exists', "Tämä FTP-tili on jo olemassa.");
