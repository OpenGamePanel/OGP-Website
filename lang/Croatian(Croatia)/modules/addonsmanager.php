...
define('OGP_LANG_select_addon', "Odaberite Addon");
...
define('OGP_LANG_type', "Vrsta Addona");
define('OGP_LANG_game', "Igra");
define('OGP_LANG_show_all_addons', "Pokaži sve Addone");
define('OGP_LANG_show_addons_for_selected_type', "Pokaži Addone Za Odabranu Vrstu");
define('OGP_LANG_show_addons_for_selected_game', "Pokaži Addone Za Odabranu Igru");
define('OGP_LANG_linux_games', "Linuks Igre");
define('OGP_LANG_windows_games', "Windows Igre");
define('OGP_LANG_create_addon', "Stvoriti Addon");
define('OGP_LANG_addons_db', "Baza Podataka Za Addone");
define('OGP_LANG_addon_has_been_created', "Addon 1 %s Uspješno Stvoren.");
define('OGP_LANG_remove_addon', "Ukloniti Addon");
define('OGP_LANG_fill_the_url_address_to_a_compressed_file', "Molimo ispunite URL adresu za komprimiranu datoteku.");
define('OGP_LANG_fill_the_addon_name', "Molimo ispunite naziv paketa za Addone.");
define('OGP_LANG_select_an_addon_type', "Molimo, odaberite vrstu Addona");
define('OGP_LANG_select_a_game_type', "Molimo, odaberite vrstu Igre");
define('OGP_LANG_edit_addon', "Uredi Addon");
define('OGP_LANG_post-script', "Post-instalacija skripte (bash)");
define('OGP_LANG_replacements', "Zamjene:");
define('OGP_LANG_addon_name_info', "Unesite naziv za ovaj Addon, to je naziv koji korisnik vidi.");
...
define('OGP_LANG_show_addons_for_selected_group', "Prikaži Addone za odabranu grupu");
