...
define('home_id', "Szerver azonosító");
define('home_path', "Szerver elérési útja");
define('game_type', "Játék típus");
define('port', "Port");
define('invalid_values', "Érvénytelen értékek.");
define('ports_in_range_already_arranged', "A portok a tartományban már elrendezve.");
define('ports_range_already_configured_for', "A portok tartománya már konfigurálva a(z) %s-hoz.");
define('ports_range_added_successfull_for', "A(z) %s portok tartományának a hozzáadása sikeres.");
define('ports_range_deleted_successfull', "A portok tartománya sikeresen törölve.");
