...
define('remote_encryption_key_info', "A távoli titkosítási kulcs a Panel és az Agent(ek) közötti adatok titkosításához használandó. Ennek a kulcsnak egyformának kell lennie mindkét oldalon.");
...
define('encryption_key_mismatch', "A titkosítási kulcs nem egyezik az Agentel. Ellenőrizd újra a konfigurációs fájlokat.");
...
define('remote_host_ftp_ip_info', "Az FTP szerver <b>IP</b> az jelenlegi Agent-nek.");
...
define('reset_firewall', "Tűzfal újraindítása");
