...
define('vstoken_new_select_group', "Szerver csoport");
...
define('vsliveview_channelbackup_head', "Csatorna biztonsági mentése");
define('vsliveview_channelbackup_get', "létrehozni és letölteni");
define('vsliveview_channelbackup_load', "Csatorna biztonsági mentésének a feltöltése");
define('vsliveview_channelbackup_load_submit', "újraalkot");
define('vsliveview_channelbackup_new_added_ok', "Csatorna biztonsági mentése sikeres.");
define('time_day', "nap");
define('time_days', "napok");
define('time_hour', "óra");
define('time_hours', "órák");
define('time_minute', "perc");
define('time_minutes', "percek");
define('time_second', "másodperc");
define('time_seconds', "másodpercek");
