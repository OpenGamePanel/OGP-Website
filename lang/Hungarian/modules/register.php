...
define('OGP_LANG_users_fname', "Keresztnév");
define('OGP_LANG_users_lname', "Vezetéknév");
define('OGP_LANG_users_passwd', "Jelszó");
define('OGP_LANG_users_cpasswd', "Jelszó ismét");
define('OGP_LANG_passwd_len', "A jelszónak hosszabbnak kell lennie mint 6 karakter");
...
define('OGP_LANG_err_last_name', "A vezetéknév nincs megadva.");
...
define('OGP_LANG_user_registration', "Felhasználó regisztrálása");
define('OGP_LANG_your_account_details_has_been_sent_by_email_to', "A fiók adataid a(z) <b>%s</b> e-mail címre elküldve.");
define('OGP_LANG_account_created', "A fiókod elkészült.");
define('OGP_LANG_subject', "%s :: Fiók adatok");
?>