...
$lang['maintenance_mode'] = "Karbantartás";
$lang['maintenance_mode_info'] = "Egy üzenet lesz megjelenítve a normál felhasználóknak a karbantartás alatt.";
...
$lang['maintenance_message'] = "Üzenet";
$lang['maintenance_message_info'] = "Ez az üzenet lesz megjelenítve a felhasználóknak a karbantartás alatt.";
$lang['update_settings'] = "Beállítások frissítése";
$lang['settings_updated'] = "Beállítások sikeresen frissítve.";
$lang['panel_language'] = "Nyelv";
$lang['panel_language_info'] = "A panel alapértelmezett nyelve. A felhasználók meg tudják változtatni a saját nyelvükre a profil beállításokban.";
$lang['page_auto_refresh'] = "Oldal automatikus frissítése";
$lang['page_auto_refresh_info'] = "Az oldal automatikus frissítése kikapcsolható debuggolási célból. Normál használat esetén érdemes bekapcsolni.";
$lang['smtp_server'] = "Kimeno email szerver";
$lang['smtp_server_info'] = "Ez a szerver lesz használva a kimeno leveleknek (SMTP szerver), például az elfelejtett jelszavak kiküldéséhez, localhost alapértelmezés szerint.";
$lang['panel_email_address'] = "Kimeno levelek küldoje";
$lang['panel_email_address_info'] = "Ez az email cím lesz használva a kimeno levelek küldojeként.";
...
$lang['charset'] = "Karakterkódolás";
$lang['charset_info'] = "UTF8, ISO, ASCII, stb .. hagyta üresen az ISO kódolást.";
...
$lang['themes'] = "Téma beállítások";
$lang['theme'] = "Kinézet";
$lang['theme_info'] = "A kiválasztott kinézet lesz az alapbeállítás minden felhasználónak. A felhasználók meg tudják változtatni ezt a beállítást a profil oldalukon.";
$lang['welcome_title'] = "Üdvözöljük címe";
$lang['welcome_title_info'] = "Lehetové teszi, hogy a cím jelenik meg a muszerfalra.";
$lang['welcome_title_message'] = "Üdvözöljük Cím Üzenet";
$lang['welcome_title_message_info'] = "A cím üzenet jelenik meg a muszerfalra (HTML nem engedélyezett).";
