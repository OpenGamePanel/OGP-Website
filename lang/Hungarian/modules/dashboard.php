...
define('dashboard_addons_manager_text', "Kezeld az összes különböző típusú szolgáltatást az OGP-vel. Válassz a több mint 115 szerver közül, amelyeket közvetlenül szállít az OGP.");
...
define('no_games_to_monitor', "Jelenleg nincsenek online/offline játékszerverek");
define('online_servers', "Online szerverek");
define('add_games_in', "Ha játékokat szeretnél hozzáadni azt megteheted itt %s");
