...
define('game_path_info', "A szerver teljes elérési útja. Példa: /home/ogp/szerverem/");
...
define('game_home_added', "Játék szerver hozzáadása sikeres. Átirányítás a szerkesztés oldalra.");
...
define('control_password_update_failed', "A vezérlő jelszó frissítése nem sikerült");
...
define('successfully_removed_mod', "Játék mód sikeresen eltávolítva.");
...
define('set_as_master_server', "Beállítás mester szervernek");
...
define('successfully_deleted_game_server_with_id', "Sikeresen törölve a játékszerver (ID: %s).");
...
define('connection_timeout_or_problems_reaching_the_agent', "Kapcsolat időtúllépés vagy hiba az Agent elérése közben");
define('does_not_exist_yet', "Még nem létezik.");
define('go_to_custom_fields', "Tovább az egyéni mezőkhöz");
define('back_to_edit_server', "Vissza a szerkesztéshez");
...
define('cancel', "Mégse");
define('set_this_path', "Útvonal beállítása");
