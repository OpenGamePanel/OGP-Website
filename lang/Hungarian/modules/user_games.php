...
define('OGP_LANG_no_game_configurations_found', "Nem található játék konfiguráció. Hozzá kell adnod a játék konfigurációkat a");
...
define('OGP_LANG_game_control_password', "Játékvezérlő jelszó");
...
define('OGP_LANG_set_ip', "IP beállítása");
define('OGP_LANG_ips_and_ports', "IP-k és Portok");
define('OGP_LANG_mod_name', "Mod név");
define('OGP_LANG_max_players', "Max. játékos");
define('OGP_LANG_extra_cmd_line_args', "Extra parancssori paraméterek");
define('OGP_LANG_extra_cmd_line_info', "Az extra parancssori paramétert megadva a szerver indulásakor megadhatsz extra paramétereket.");
define('OGP_LANG_cpu_affinity', "CPU affinitás");
define('OGP_LANG_nice_level', "Nice Szint");
define('OGP_LANG_set_options', "Beállítások beállítása");
define('OGP_LANG_remove_mod', "Mod eltávolítása");
...
define('OGP_LANG_error_ocurred_on_remote_server', "Hiba történt a távoli szerveren,");
...
define('OGP_LANG_mod_install_cmds', "Mod telepítési parancsok");
define('OGP_LANG_cmds_for', "Parancsok a");
define('OGP_LANG_preinstall_cmds', "Előtelepítési parancsok");
define('OGP_LANG_postinstall_cmds', "Utótelepítési parancsok");
define('OGP_LANG_edit_preinstall_cmds', "Előtelepítési parancsok szerkesztése");
define('OGP_LANG_edit_postinstall_cmds', "Utótelepítési parancsok szerkesztése");
define('OGP_LANG_save_as_default_for_this_mod', "Mentés alapértelmezettnek ehhez a modhoz");
define('OGP_LANG_empty', "üres");
...
define('OGP_LANG_change_ftp_account_status_info', "Ha egy FTP fiók engedélyezve vagy tiltva van, akkor az hozzáadásra vagy eltávolításra kerül az FTP adatbázisából.");
define('OGP_LANG_server_ftp_login', "Szerver FTP bejelentkezés");
define('OGP_LANG_change_ftp_login_info', "Az FTP bejelentkezés megváltoztatása egy személyre szabottra.");
define('OGP_LANG_change_ftp_login', "FTP bejelentkezés megváltoztatása");
define('OGP_LANG_ftp_login_can_not_be_changed', "Nem lehet megváltoztatni az FTP bejelentkezést.");
define('OGP_LANG_server_is_running_change_addresses_not_available', "A szerver jelenleg fut, az IPt nem lehet megváltoztatni.");
define('OGP_LANG_change_game_type', "Játék típusának megváltoztatása");
define('OGP_LANG_change_game_type_info', "A játék típus megváltoztatásával a jelenlegi modok konfigurációja törlésre kerül.");
define('OGP_LANG_force_mod_on_this_address', "Mód kényszerítése ezen a címen");
define('OGP_LANG_successfully_assigned_mod_to_address', "A mod sikeresen hozzárendelve a címhez");
define('OGP_LANG_switch_mods', "Módok váltása");
define('OGP_LANG_switch_mod_for_address', "Mód váltása a(z) %s címhez");
define('OGP_LANG_invalid_path', "Érvénytelen útvonal");
...
define('OGP_LANG_allow_file_management_info', "Engedélyezi a felhasználónak, hogy hozzáférjen a játék szerverhez a fájlkezelő modullal.");
define('OGP_LANG_allow_parameter_usage', "Paraméter használat engedélyezése");
define('OGP_LANG_allow_parameter_usage_info', "Engedélyezi a felhasználónak, hogy megváltoztathassa az elérhető parancssori paramétereket.");
define('OGP_LANG_allow_extra_params', "Extra paraméterek engedélyezése");
define('OGP_LANG_allow_extra_params_info', "Engedélyezi a felhasználónak, hogy módosítsa az extra parancssori paramétereket.");
define('OGP_LANG_allow_ftp', "FTP engedélyezése");
...
define('OGP_LANG_game_server_copy_failed_with_return_code', "Játékszerver másolása sikertelen a(z) %s visszatérési kóddal.");
...
define('OGP_LANG_sucessfully_deleted', "A(z) %s sikeresen törölve.");
define('OGP_LANG_the_agent_had_a_problem_deleting', "Az Agentnek problémája volt a(z) %s törlése közben. Kérlek, ellenőrizd az Agent naplóját.");
define('OGP_LANG_connection_timeout_or_problems_reaching_the_agent', "Kapcsolat időtúllépés vagy problémák az Agent elérésével");
define('OGP_LANG_does_not_exist_yet', "Még nem létezik.");
define('OGP_LANG_update_settings', "Beállítások frissítése");
define('OGP_LANG_settings_updated', "Beállítások frissítve.");
define('OGP_LANG_selected_path_already_in_use', "A kiválasztott útvonal már használatban van.");
...
define('OGP_LANG_level_up', "Szintlépés");
define('OGP_LANG_level_up_info', "Vissza az előző mappához.");
define('OGP_LANG_add_folder', "Mappa hozzáadása");
define('OGP_LANG_add_folder_info', "Írd le a nevét az új mappának, majd kattints az ikonra.");
define('OGP_LANG_valid_user', "Kérlek, határozz meg egy érvényes felhasználót.");
define('OGP_LANG_valid_group', "Kérlek, határozz meg egy érvényes csoportot.");
