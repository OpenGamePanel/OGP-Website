...
define('sql_delete_info', "Engedélyezi a TÖRLÉS használatát.");
define('sql_drop_info', "Engedélyezi a TÁBLA TÖRLÉSE használatát.");	
define('sql_index_info', "<b>Enables use of CREATE INDEX and DROP INDEX.</b>");	
define('sql_insert_info', "Engedélyezi az ÚJ SOR BEVITELE használatát.");	
