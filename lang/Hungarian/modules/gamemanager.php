...
define('failed_to_start_rsync_update', "Rsync frissítés elindítása sikertelen. Nézd meg az Agent naplóját.");
...
define('server_restarted', "A '%s' szerver újraindítva.");
...
define('dest_filename_info', "A célfájlt fájlneve.");
