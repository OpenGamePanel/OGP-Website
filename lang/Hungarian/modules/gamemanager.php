...
define('extra_parameters_info', "Ezek a paraméterek az indítóparancs végére kerülnek, amikor a játék szerver elindult.");
define('game_exec_not_found', "A játék indítófájla %s helyen nem található.");
define('select_params_and_start', "Válaszd ki az indítási paramétereket a szerver számára és nyomj '%s'-t.");
...
define('server_stopped', "A(z) '%s' szerver leállt.");
define('if_want_to_start_homes', "Ha játék szervereket akarsz elindítani, akkor menj a %s-ba.");
define('view_log', "Naplómegjelenítő");
...
define('unable_retrieve_mod_info', "Nem sikerült lekérni a mod információt az adatbázisból.");
...
define('edit_configuration_files', "Konfigurációs fájlok szerkesztése");
...
define('custom_fields', "Egyéni mezők");
?>