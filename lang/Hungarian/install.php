...
define('OGP_LANG_unable_to_write_config', "Nem sikerült írni a konfigurációs fájlba. Kérlek, ellenőrizd újra az írási engedélyt.");
define('OGP_LANG_admin_login_details', "Adminisztrátor bejelentkezési adatok");
define('OGP_LANG_config_written', "A konfigurációs fájl létrehozása sikeres.");
...
define('OGP_LANG_invalid_email_address', "Érvénytelen e-mail címet adtål meg.");
define('OGP_LANG_setup_complete', "A telepítés sikeresen befejeződött. Az Open Game Panel készen áll a használatra.");
define('OGP_LANG_remove_install_and_secure_config', "Biztonsági okokból törölnöd kell az install.php fájlt a szerveredről és változtasd meg az includes/config.inc.php fájl hozzáférési jogát 644-re.");
define('OGP_LANG_go_to_panel', "Kattints ide az OGP-be való belépéshez.");
define('OGP_LANG_unable_to_resolve', "Ha nem tudod megoldani ezt a problémát, kérlek, látogasd meg az OGP weboldalát");
define('OGP_LANG_slogan', "A nyílt forráskódú!");
define('OGP_LANG_default_welcome_title_message', "Üdvözöljük! <b style='font-size:12px; font-weight:normal;'>Ezt az üzenetet megváltoztathatod a '<a href='?m=settings&p=themes'>Téma beállításokban</a>' az '<a href='?m=administration&p=main'>Adminisztráció</a>' fül alatt.</b>");
?>