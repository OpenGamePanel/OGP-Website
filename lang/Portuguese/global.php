...
define('OGP_LANG_already_logged_in_redirecting_to_dashboard', "Desculpe, mas você já tem sessão iniciada, será agora redireccionado para a pagina de inicio.");
define('OGP_LANG_logging_in', "<center>Sessão iniciada com sucesso, Por favor aguarde...</center>");
define('OGP_LANG_redirecting_in', "Você esta a ser redireccionado, por favor aguarde...");
...
define('OGP_LANG_logout_message', "Você acabou de terminar a sessão, agradecemos a sua visita!");
...
define('OGP_LANG_lost_passwd', "Perdeu a sua senha?");
define('OGP_LANG_no_db_connection', "Não é possível conectar ao banco de dados.");
define('OGP_LANG_bad_login', "Senha ou nome de usuário incorrectos.");
define('OGP_LANG_not_logged_in', "Você não está conectado no momento.");
...
define('OGP_LANG_on', "Ligado");
define('OGP_LANG_off', "Desligado");
define('OGP_LANG_db_error_invalid_host', "Foi inserido um host de banco de dados inválido.");
define('OGP_LANG_db_error_invalid_user_and_pass', "Nome de usuário ou senha de banco de dados inválido.");
define('OGP_LANG_db_error_invalid_database', "Banco de dados invalido.");
...
define('OGP_LANG_invalid_login_information', "Tipo de banco de dados inválido no arquivo de configuração.");
...
define('OGP_LANG_contact_admin_to_enable_account', "Verifique na área do cliente sua conta ou entre em contacto com o administrador para reactivar a sua conta.");
define('OGP_LANG_maintenance_mode_on', "O modo de manutenção está ligado");
define('OGP_LANG_logging_out_10', "A deslogar da sua conta em 10 segundos");
define('OGP_LANG_invalid_redirect', "A rederecionar...");
...
define('OGP_LANG_not_available', "Sem informação disponível");
...
define('OGP_LANG_gamemanager', "Gerir Jogos");
define('OGP_LANG_game_monitor', "Monitor de Jogos");
...
define('OGP_LANG_shop_guest', "Loja de Compras");
...
define('OGP_LANG_settings', "Definições do painel");
...
define('OGP_LANG_addons_manager', "Gerir Addons");
...
define('OGP_LANG_get_size', "Mostrar tamanho");
define('OGP_LANG_total_size', "Tamanho total");
define('OGP_LANG_lgsl', "Lista de servidores tempo real");
define('OGP_LANG_lgsl_admin', "ADMIN - lista de servidores tempo real ");
define('OGP_LANG_rcon', "RCON");
define('OGP_LANG_watch_logger', "Logs do Servidor");
define('OGP_LANG_litefm_settings', "Config. LiteFileManeger");
define('OGP_LANG_assign_expiration_date', "Data em que ira expirar a app/servidor");
define('OGP_LANG_assign_expiration_date_info', "Uma vez que expira, o servidor não está atribuído mas não foi removido.");
define('OGP_LANG_server_expiration_date', "Data de expiração");
...
define('OGP_LANG_admin_dsi', "Config. Imagem Dinâmica de Servidores");
define('OGP_LANG_user_dsi', "Imagem Dinâmica de Servidor");
define('OGP_LANG_list_dsi', "Lista de Servidores de Jogos Ativos");
...
define('OGP_LANG_admin_news', "Notícias - Administrador");
define('OGP_LANG_util', "Serviços/utiliarios");
define('OGP_LANG_fast_download', "Fast Download");
define('OGP_LANG_fd_user', "Fast Download");
define('OGP_LANG_cron', "Administrador - programador de tarefas");
define('OGP_LANG_user_cron', "Programador de tarefas CRON");
define('OGP_LANG_faq', "Perguntas Frequentes");
define('OGP_LANG_mysql_admin', "MySQL Admin");
define('OGP_LANG_copied', "Copiado!");
define('OGP_LANG_ticket_settings', "Definições de Ticket");
define('OGP_LANG_form', "Registar");
?>