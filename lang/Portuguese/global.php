...
define('invalid_home_id', 'Invalid home id');
define('note', 'Note');
define('hint', 'Hint');
define('yes', 'Yes');
define('no', 'No');
define('on', 'On');
define('off', 'Off');
define('db_error_invalid_host', 'Db error invalid host');
define('db_error_invalid_user_and_pass', 'Db error invalid user and pass');
define('db_error_invalid_database', 'Db error invalid database');
define('db_unknown_error', 'Db unknown error');
define('db_error_module_missing', 'Db error module missing');
define('db_error_invalid_db_type', 'Db error invalid db type');
define('invalid_login_information', 'Invalid login information');
define('failed_to_read_config', 'Failed to read config');
define('account_expired', 'Account expired');
define('contact_admin_to_enable_account', 'Contact admin to enable account');
define('maintenance_mode_on', 'Maintenance mode on');
define('module_not_installed', 'Module not installed');
define('no_access_to_home', 'No access to home');
