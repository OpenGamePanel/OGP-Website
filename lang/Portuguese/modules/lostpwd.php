...
define('password_message', "Oi,<br>Você ou alguém redefinir sua senha.<br><br>Nova senha: %s<br>Uma vez logado, você pode alterar sua senha<br><br>Obrigado!<br>site admin<br><br>Esta é uma resposta automática, por favor, não responda!");
...
define('click', "Clique");
define('mail_settings_missing', "As configurações de email do painel não estão completas, portanto não é possível enviar sua senha. Entre em contato com o administrador do seu OGP.");
define('mail_failed', "Falha ao enviar o email.");
define('email', "Endereço de email");
define('enter_email', "Por favor, indique o seu endereço de email");
