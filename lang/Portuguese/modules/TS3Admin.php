...
define('error', "Erro");
define('title', "TeamSpeak 3 Interface Web");
define('update_available', "<h3>Atenção: uma nova versão (v%1) deste software está disponível sob <a href=\"%2\" target=\"_blank\">%2</a>.</h3>");
...
define('js_prompt_msg_to', "Mensagem de texto para %1 #%2: ");
...
define('vsselect_new_slots', "Slots do cliente");
...
define('vsoverview_info_general_head', "Configurações Globais");
define('vsoverview_info_servername', "Nome do servidor");
define('vsoverview_info_host', "Host/Anfitrião ");
...
define('vsoverview_info_hostmsg', "Mensagem do host/anfitrião");
...
define('vsoverview_info_req_securitylvl', "obrigatório");
define('vsoverview_info_hostbanner_head', "Imagem do Servidor ");
define('vsoverview_info_hostbanner_url', "URL endereço local/web");
define('vsoverview_info_hostbanner_imgurl', "Endereço da imagem");
define('vsoverview_info_hostbanner_buttonurl', "Botão URL do HOST");
