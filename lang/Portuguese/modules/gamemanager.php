...
define('OGP_LANG_game_manager', "Gestão do Servidor");
...
define('OGP_LANG_no_game_homes_assigned', "Não há servidores de jogos associados a sua conta. Entre em contato com um administrador para que ele possa adicionar um para você.");
...
define('OGP_LANG_ogp_agent_ip', "IP do Server Agent");
...
define('OGP_LANG_start_wait_note', "A inicialização do servidor pode levar uns breves instantes. Por Favor não faça REFRESH a pagina, não feche a pagina ou encerre o navegador. O próprio PAINEL fará tudo isso por si... Apenas tenha um pouco de paciência se demorar alguns segundos.");
define('OGP_LANG_game_type', "Tipo de Jogo");
define('OGP_LANG_map', "Mapa");
define('OGP_LANG_starting_server', "A iniciar o servidor, por favor aguarde uns instantes...");
define('OGP_LANG_starting_server_settings', "A iniciar o servidor com as seguintes configurações");
define('OGP_LANG_startup_params', "Parâmetros de inicialização");
define('OGP_LANG_startup_cpu', "CPU em que o servidor está em execução");
define('OGP_LANG_startup_nice', "Defina a prioridade do server");
...
define('OGP_LANG_game_exec_not_found', "O servidor executado %s não foi encontrado no servidor remoto.");
define('OGP_LANG_select_params_and_start', "Selecione os parâmetros de inicialização para o servidor e clique em '%s'.");
define('OGP_LANG_no_ip_port_pairs_assigned', "Não há um IP e porta associados para este directório. Se você não tem acesso a edição do mesmo, entre em contacto com um administrador.");
define('OGP_LANG_unable_to_get_log', "Falha ao obter resposta do log, status %s.");
...
define('OGP_LANG_server_not_running_log_found', "O servidor não está em execução, mas um registo de log foi encontrado. NOTA: Esse registo pode não ser relacionado à ultima vez que o servidor foi iniciado.");
define('OGP_LANG_ip_port_pair_not_owned', "IP:PORT não é dono deste par.");
define('OGP_LANG_unsuitable_maxplayers_value_maximum_reachable_number_of_slots_has_been_set', "O valor maxplayers não não se encontra adequado, o número máximo de slots alcançado foi definido.");
define('OGP_LANG_server_running_not_responding', "O servidor está em execução mas não está a responder, <br>pode possivelmente haver algum tipo de problema e talvez você queira");
define('OGP_LANG_update_started', "Actualização iniciada, por favor aguarde...");
define('OGP_LANG_failed_to_start_steam_update', "Falha ao iniciar a actualização via Steam. Verifique o log do agente para  averiguar com mais detalhes.");
...
define('OGP_LANG_refresh_steam_status', "Actualize o status da Steam");
define('OGP_LANG_refresh_rsync_status', "Actualize o status rsync");
...
define('OGP_LANG_stop_update', "Pare de actualizar");
...
define('OGP_LANG_no_rights_to_stop_server', "Você não tem permissões para parar este servidor.");
...
define('OGP_LANG_view_log', "Verificação de Logs");
define('OGP_LANG_if_want_manage', "Se você deseja fazer a gestão dos seus jogos você pode fazê-lo na");
...
define('OGP_LANG_restarting_server', "A reiniciar servidor, por favor aguarde...");
...
define('OGP_LANG_maps_read_from', "Mapas obtidos do");
...
define('OGP_LANG_error_server_already_running', "ERRO: Já existe um servidor nesta mesma porta");
define('OGP_LANG_failed_start_server_code', "Falha ao iniciar servidor remoto. Código de erro: %s");
define('OGP_LANG_disabled', "desactivado ");
...
define('OGP_LANG_query_protocol_not_supported', "* Não há protocolo de consulta no painel que possa ser suportado neste servidor.");
...
define('OGP_LANG_add_preset', "Adicionar predefinido");
...
define('OGP_LANG_edit_configuration_files', "Editar arquivos de configuração");
