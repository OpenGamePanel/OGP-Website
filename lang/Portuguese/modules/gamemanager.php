...
define('fail_no_mods', "Não há mods habilitados para este jogo! Você precisa pedir ao seu administrador do painel para adicionar mod(s) para o jogo atribuído para você.");
...
define('unsuitable_maxplayers_value_maximum_reachable_number_of_slots_has_been_set', "Máximo valor máximo dos jogadores, o número máximo alcançável de slots foi definido.");
...
define('query_protocol_not_supported', "* Não há protocolo de consulta nopainel que possa ser suportado neste servidor.");
...
define('add_preset', "Adicionar predefinição");
define('edit_presets', "Editar presets");
