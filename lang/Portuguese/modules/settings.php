...
define('old_dashboard_behavior_info', "O painel antigo estava a funcionar de forma mais lenta, mas mostra mais informações do servidor (por exemplo, jogadores e mapas atuais).");
define('rsync_available', "Servidores de sincronização remota disponíveis");
...
define('support_widget_content_info', "O conteúdo do widget de suporte (código HTML permitido).");
...
define('welcome_title_info', "Permite o título seja exibido na parte superior do Painel.");
define('welcome_title_message', "Bem-vindo a Mensagem de título");
define('welcome_title_message_info', "A mensagem de título que é exibida na parte superior do painel (código HTML permitido).");
...
define('default_game_server_home_path_prefix_info', "Digite um prefixo de caminho para onde você deseja que os caminhos do servidor do jogo sejam criadas por padrão. Você pode usar \"{USERNAME}\" no caminho que será substituído pelo nome de usuário do seu painel ao qual o servidor do jogo está sendo atribuído.  Exemplo: /ogp/games/{USERNAME} se tornará /ogp/games/username/1 onde 1 é a identificação dos servidores do jogo.  Exemplo 2:  /ogp/games will become /ogp/games/2 onde 2 é a identificação dos servidores do jogo.");
?>
