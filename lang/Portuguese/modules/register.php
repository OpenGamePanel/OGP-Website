...
define('users_passwd', "Senha");
define('users_cpasswd', "Confirmar senha");
define('passwd_len', "A senha precisa ter pelo menos 6 caracteres");
define('err_password', "A senha não pode estar em branco");
define('err_confirm_password', "O campo de confirmação da senha não pode estar em branco");
define('err_password_mismatch', "As senhas não conferem");
