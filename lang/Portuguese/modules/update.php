...
define('files_not_overwritten', "%s arquivos não substituídos devido a lista negra");
...
define('get_x_revison_messages_may_take_some_time', "Obter mensagens de revisão %s podem levar algum tempo.");
