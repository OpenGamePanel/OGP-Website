...
define('pear_xxtea_info', "O módulo Pear Crypt_XXTEA'é necessário para utilizar o OGP. Na maioria das variações Linux, este módulo pode ser instalado através do repositório pear com o comando 'pear install Crypt_XXTEA-beta'.");
define('refresh', "Atualizar");
define('checking_required_modules', "Checando os módulos exigidos");
...
define('unable_to_write_config', "Não é possível escrever as configurações. Por favor verificar as permissões de escrita.");
...
define('php_version_check', "Checando a versão do PHP.");
...
define('invalid_email_address', "Você digitou um endereço de email inválido.");
