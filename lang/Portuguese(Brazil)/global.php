...
define('already_logged_in_redirecting_to_dashboard', "<center>Você já está logado, Redirecionando ao dashboard.</cente>");
define('logging_in', "<center>Login efetuado com sucesso, Redirecionando aguarde...</center>");
define('redirecting_in', "Redirecionando em");
...
define('on', "On");
define('off', "Off");
define('db_error_invalid_host', "O host de banco de dados inválido foi inserido.");
define('db_error_invalid_user_and_pass', "Nome de usuário e / ou senha de banco de dados inválido.");
define('db_error_invalid_database', "Banco de dados ");
...
define('contact_admin_to_enable_account', "Verifique na Área do cliente sua conta ou Entre em contato com o administrador para reativar sua conta.");
define('maintenance_mode_on', "O modo de manutenção está ligado");
define('logging_out_10', "Saindo da conta em 10 segundos");
define('invalid_redirect', "Redirecionando...");
...
define('game_monitor', "Gerenciador de Servers");
...
define('lang', "Idioma");
define('get_size', "Ver tamanho");
define('total_size', "Tamanho total");
define('lgsl', "LGSL");
define('lgsl_admin', "LGSL Admin");
define('rcon', "RCON");
define('watch_logger', "Ver Logger");
define('litefm_settings', "Configurações LiteFM");
define('assign_expiration_date', "Data de expiração do servidor");
...
define('admin_dsi', "Configurações DSi");
define('user_dsi', "DSi");
