...
define('OGP_LANG_install_welcome', "Seja bem vindo ao instalador do painel de controle Open Game Panel");
...
define('OGP_LANG_encryption_key', "Chave de segurança (Agente)");
...
define('OGP_LANG_admin_login_details_info', "Agora criaremos um usuário administrador para seu painel de controle Open Game Panel.");
...
define('OGP_LANG_php_version_check', "Verificando a versão do PHP:");
...
define('OGP_LANG_go_to_panel', "Clique aqui para entrar em seu painel de controle OGP.");
define('OGP_LANG_unable_to_resolve', "Se você não conseguir resolver este problema visite o site do OGP");
define('OGP_LANG_slogan', "De Código Aberto!");
