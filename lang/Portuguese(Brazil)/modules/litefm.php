...
define('OGP_LANG_upload', "Enviar");
define('OGP_LANG_upload_failed', "O carregamento falhou, o erro foi: %s .");
...
define('OGP_LANG_upload_file', "Enviar arquivo");
...
define('OGP_LANG_send_by_email_info', "Para enviar arquivos, o pacote 'mutt' deve ser instalado no lado do agente.");
