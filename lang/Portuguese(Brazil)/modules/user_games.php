...
define('OGP_LANG_change_control_password_info', "A senha de controle é, por exemplo, senha do RCON.");
...
define('OGP_LANG_no_ip_ports_assigned', "Pelo menos um IP: o par de portas deve ser atribuído ao caminho mestre\"home\".");
...
define('OGP_LANG_allow_file_management', "Permitir Gerenciador de Arquivos");
...
define('OGP_LANG_clone_home', "Diretório clone");
define('OGP_LANG_new_home_name', "Novo nome do diretório");
define('OGP_LANG_new_home_path', "Novo caminho de diretório");
...
define('OGP_LANG_mods_and_settings_for_this_game_server', "Mods e configurações para este servidor de jogo");
...
define('OGP_LANG_failed_to_remove_gamehome_from_database', "Falha ao remover o gamehome do banco de dados.");
...
define('OGP_LANG_the_agent_had_a_problem_deleting', "Problema no Agente ao deletar %s. Favor verificar o log do Agente.");
...
define('OGP_LANG_cpu_affinity_info', "Selecione o(s) núcleos do CPU que deseja atribuir ao servidor do jogo.");
