...
define('game_server_name_info', "O nome de cada servidor ajuda os usuários a identificar seus servidores.");
...
define('add_game_home', "Adicionar servidor de jogos");
...
define('game_control_password', "Senha de controle do jogo");
define('change_control_password_info', "A senha de controle é, por exemplo, senha do RCON.");
