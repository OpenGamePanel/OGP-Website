...
define('OGP_LANG_agent_status', "Status Agent");
...
define('OGP_LANG_view_log', "Exibir Log");
...
define('OGP_LANG_remote_ips_for', "IPs para servidores de jogos usarem no Servidor Agent '%s'");
...
define('OGP_LANG_use_nat_info', "Ative se o seu servidor remoto estiver usando regras NAT. Use essa configuração se os servidores do jogo estiverem sendo executados em endereços IP internos da LAN, para que o painel use seu endereço IP remoto real para consultar os servidores de jogos.");
