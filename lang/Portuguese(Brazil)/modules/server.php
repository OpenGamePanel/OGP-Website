...
define('remote_host_port_info', "A porta que esta em escuta pelo Painel Agent no host remoto. Padrão: 12679.");
...
define('note_remote_host', "Um host remoto é um servidor onde o Painel Agent está funcionando. Cada host pode ter um número múltiplo de endereços IP nos quais os usuários podem ligar servidores.");
...
define('remote_host_ftp_ip_info', "O servidor FTP <b>IP</b> para o atual Agente.");
define('remote_host_ftp_port', "Porta FTP");
define('remote_host_ftp_port_info', "O servidor FTP <b>port</b> para o atual Agente.");
...
define('areyousure_removeagent', "Tem certeza de que deseja remover o agente chamado");
...
define('timeout_info', "O limite de tempo em segundos para obter a resposta deste Agente.");
