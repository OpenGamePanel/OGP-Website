...
define('OGP_LANG_updating_configs', "Atualizando configurações antigas.");
...
define('OGP_LANG_config_reset_warning', "Quando você limpa configurações antigas, pode haver problemas com os servidores de jogos atribuídos, porque os números de identificação podem não corresponder com as novas configurações.");
...
define('OGP_LANG_updating_config_from_file', "Atualizando a configuração do arquivo %s.");
...
define('OGP_LANG_failed_to_delete_config_from_db', "Falha ao excluir a configuração %s do banco de dados");
