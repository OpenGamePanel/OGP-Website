...
define('OGP_LANG_failed_to_start_file_download', "Falha ao inciar download do arquivo.");
define('OGP_LANG_no_games_servers_available', "Não existem servidores de jogos disponíveis na sua conta.");
define('OGP_LANG_addon_installed_successfully', "Addon instalado com sucesso");
define('OGP_LANG_path', "Caminho");
define('OGP_LANG_wait_while_decompressing', "Aguarde enquanto o arquivo %s é descompactado.");
define('OGP_LANG_addon_name', "Nome do Addon");
...
define('OGP_LANG_type', "Tipo de Addon");
define('OGP_LANG_game', "Jogo");
define('OGP_LANG_show_all_addons', "Mostrar todos Addons ");
...
define('OGP_LANG_create_addon', "Criar Addon");
define('OGP_LANG_addons_db', "Banco de Dados Addons");
define('OGP_LANG_addon_has_been_created', "O addon %s foi criado.");
define('OGP_LANG_remove_addon', "Remover Addon");
define('OGP_LANG_fill_the_url_address_to_a_compressed_file', "Por favor, substitua o endereço da URL para comprimir o arquivo.");
define('OGP_LANG_fill_the_addon_name', "Por favor, insira um nome para o pacote de addon.");
define('OGP_LANG_select_an_addon_type', "Por favor, selecione o tipo de addon.");
define('OGP_LANG_select_a_game_type', "Selecione um tipo de jogo.");
define('OGP_LANG_edit_addon', "Editar Addon");
define('OGP_LANG_post-script', "Script pós-instalação (Bash)");
define('OGP_LANG_replacements', "Substituições:");
define('OGP_LANG_addon_name_info', "Digite um nome para este addon, este será o nome que o usuário irá ver.");
...
define('OGP_LANG_show_to_group', "Mostrar para o grupo");
define('OGP_LANG_all_groups', "Todos os grupos");
define('OGP_LANG_show_addons_for_selected_group', "Mostrar Addons para o grupo selecionado");
