...
define('OGP_LANG_show_to_group', "Visa för grupp");
define('OGP_LANG_all_groups', "Alla grupper");
define('OGP_LANG_show_addons_for_selected_group', "Visa tillägg för den utvalda gruppen");
