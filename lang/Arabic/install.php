...
define('found', "وجد");
define('not_found', "غير معثور عليه");
define('pear_xxtea_info', "Pear Crypt_XXTEA مطلوبة لاستخدام أوبن قيم بانل. في معظم توزيعات لينكس يمكن تثبيت هذه الوحدة مع أمر Pear التالي 'pear install Crypt_XXTEA-beta'.");
define('refresh', "تحديث");
define('checking_required_modules', "التحقق من الوحدات المطلوبة:");
...
define('unable_to_write_config', "تعذر الكتابة إلى ملف التهيئة. يرجى إعادة التحقق من إذن الكتابة.");
