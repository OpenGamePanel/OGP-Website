...
define('OGP_LANG_already_logged_in_redirecting_to_dashboard', "تم تسجيل الدخول بالفعل ، إعادة التوجيه إلى لوحة التحكم.");
define('OGP_LANG_logging_in', "تسجيل الدخول");
define('OGP_LANG_redirecting_in', "توجيه الى");
define('OGP_LANG_refresh_page', "تحديث الصفحة");
define('OGP_LANG_no_rights', "لا تملك صلاحيات الدخول لهذة الصفحة.");
define('OGP_LANG_welcome', "مرحباً");
...
define('OGP_LANG_solve_captcha', "التحقق البشري");
define('OGP_LANG_lost_passwd', "نسيت كلمة المرور؟");
define('OGP_LANG_no_db_connection', "لا يمكن الإتصال بقاعدة البيانات.");
define('OGP_LANG_bad_login', "خطأ في اسم المستخدم أو كلمة المرور.");
define('OGP_LANG_not_logged_in', "لم تقم بتسجيل الدخول حاليا.");
define('OGP_LANG_remove_install', "من فضلك امسح ملف install.php لأسباب تتعلق بالحماية.");
define('OGP_LANG_agent_offline', "العميل اللذي يتحكم فى هذا السيرفر مغلق.");
define('OGP_LANG_logged_in', "لقد سجلت دخولك كـ ");
define('OGP_LANG_delete', "حذف");
define('OGP_LANG_edit', "تعديل");
define('OGP_LANG_actions', "النشاطات");
define('OGP_LANG_invalid_subpage', "صفحة فرعية غير صالحة.");
define('OGP_LANG_invalid_home_id', "المعرف الذي تم ادخاله غير صالح.");
...
define('OGP_LANG_db_error_module_missing', "وحدة PHP الخاصة بقاعدة البيانات غير موجودة");
define('OGP_LANG_db_error_invalid_db_type', "نوع قاعدة بيانات غير صالح في ملف الإعدادت.");
define('OGP_LANG_invalid_login_information', "تم إدخال معلومات لتسجيل الدخول غير صالحة.");
...
define('OGP_LANG_logging_out_10', "تسجيل الخروج في 10 ثواني");
define('OGP_LANG_invalid_redirect', "إعادة التوجيه");
define('OGP_LANG_login_title', "تسجيل الدخول للوحة التحكم");
define('OGP_LANG_module_not_installed', "لم يتم تثبيت الوحدة");
define('OGP_LANG_no_access_to_home', "ليس لديك حق الوصول إلى هذا المكان.");
define('OGP_LANG_not_available', "غير موجود");
define('OGP_LANG_offline', "غير متصل");
define('OGP_LANG_online', "متصل");
define('OGP_LANG_invalid_url', "عنوان غير صالح");
define('OGP_LANG_xml_file_not_valid', "ملف الXML '%s' تعذر التحقق من صحة المخطط '%s'");
define('OGP_LANG_unable_to_load_xml', "تعذر تحميل ملف اكس ام ال. هل هي مشكلة صلاحيات وصول؟");
define('OGP_LANG_gamemanager', "مدير الألعاب");
define('OGP_LANG_game_monitor', "مراقب الألعاب");
...
define('OGP_LANG_modulemanager', "الوحدات");
...
define('OGP_LANG_watch_logger', "مشاهدة سجل عمليات المستخدمين");
define('OGP_LANG_litefm_settings', "إعدادات LiteFM");
define('OGP_LANG_assign_expiration_date', "تعيين تاريخ انتهاء الصلاحية");
define('OGP_LANG_assign_expiration_date_info', "بمجرد انتهاء صلاحية السيرفر سيتم ازالة التعيين ولكن لن يتم حذف السيرفر.");
define('OGP_LANG_server_expiration_date', "تاريخ انتهاء صلاحية السيرفر");
...
define('OGP_LANG_cron', "مدير Cron");
define('OGP_LANG_user_cron', "Cron");
define('OGP_LANG_faq', "التعليمات.");
define('OGP_LANG_mysql_admin', "مدير قاعدة البيانات MySQL");
define('OGP_LANG_copied', "تم النسخ!");
