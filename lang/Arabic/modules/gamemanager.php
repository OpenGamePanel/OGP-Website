...
define('no_game_homes_assigned', "لا خوادم لعبة مخصصة بالنسبة لك. يجب أن تطلب من مشرفك تعيين الألعاب لك.");
define('select_game_home_to_configure', "حدد خادم لعبة تريد تكوينه");
define('file_manager', "مدير الملفات");
define('configure_mods', "Configure mods");
define('install_update_steam', "تثبيت / تحديث عن طريق Steam");
define('install_update_manual', "تثبيت / تحديث يدويا");
define('assign_game_homes', "تعيين خوادم اللعبة");
define('user', "المستعمل");
define('group', "مجموعة");
define('start', "Start");
define('ogp_agent_ip', "ايبي وكيل OGP");
define('max_players', "الحد الأقصى للاعبين");
define('max', "الحد الأقصى");
define('ip_and_port', "ايبي و بورت");
define('available_maps', "الخرائط المتاحة");
define('map_path', "مسار الخريطة");
define('available_parameters', "المعلمات المتاحة");
define('start_server', "تشغيل السيرفر");
define('start_wait_note', "The server startup might take a while. Please wait without closing your browser.");
define('game_type', "نوع اللعبة");
define('map', "خريطة");
define('starting_server', "جار تشغيل السيرفر، الرجاء الانتظار ...");
...
define('server_started', "تم تشغيل السيرفر بنجاح.");
define('no_parameter_access', "ليس لديك إمكانية الوصول إلى المعلمات.");
define('extra_parameters', "Extra Parameters");
define('no_extra_param_access', "ليس لديك إمكانية الوصول إلى المعلمات الإضافية.");
...
define('update_started', "بدأ التحديث، يرجى الانتظار ...");
...
define('update_completed', "اكتمل التحديث بنجاح.");
define('update_in_progress', "جار التحديث، يرجى الانتظار ...");
...
define('stop_update', "إيقاف التحديث");
define('statistics', "الإحصاءات");
define('servers', "سيرفرات");
define('players', "لاعبين");
define('current_map', "الخريطة الحالية");
define('stop_server', "إيقاف السيرفر");
define('server_ip_port', "سيرفر ايبي:بورت");
define('server_name', "إسم السيرفر");
define('server_id', "Server ID");
define('player_name', "إسم اللاعب");
define('score', "Score");
define('time', "Time");
...
define('view_log', "سجل المشاهد");
define('if_want_manage', "If you want to manage your games you can do it in the");
define('columns', "columns");
define('group_users', "Group users:");
define('assigned_to', "مخصص ل:");
define('restart_server', "إعادة تشغيل السيرفر");
define('restarting_server', "جار إعادة تشغيل السيرفر، يرجى الانتظار ...");
...
define('already_running_stop_server', "إيقاف السيرفر.");
...
define('has_sent_to', "تم إرسالها إلى");
...
define('retry', "Retry");
define('page', "page");
define('server_cant_start', "لا يمكن تشغيل السيرفر");
define('server_cant_stop', "لا يمكن إيقاف السيرفر");
...
define('del_preset', "حذف");
define('change_preset', "Change");
define('send_command', "إرسال الأمر");
...
define('uploaded_successfully', "تم الرفع بنجاح.");
...
define('auto_update_copy_me', "نسخ");
define('auto_update_copy_me_success', "تم النسخ!");
define('auto_update_copy_me_fail', "Failed to copy. Please, manually copy the link.");
define('get_steam_autoupdate_api_link', "رابط التحديث التلقائي");
