...
define('maintenance_mode', "اعمال صيانة");
define('maintenance_mode_info', "تعطيل لوحة للمستخدمين العاديين. يمكن للمشرفين فقط الوصول إليه أثناء الصيانة.");
define('maintenance_title', "عنوان الصيانة");
define('maintenance_title_info', "العنوان الذي يتم عرضه للمستخدمين العاديين أثناء الصيانة.");
define('maintenance_message', "رسالة الصيانة");
define('maintenance_message_info', "الرسالة التي يتم عرضها للمستخدمين العاديين أثناء الصيانة.");
define('update_settings', "إعدادات التحديث");
define('settings_updated', "تم تحديث الإعدادات بنجاح.");
define('panel_language', "لغة اللوحة");
...
define('page_auto_refresh', "تحديث تلقائي للصفحة");
...
define('feed_enable', "تفغيل خلاصة LGSL");
