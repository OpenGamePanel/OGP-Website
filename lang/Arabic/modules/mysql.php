...
define('add_new_mysql_host', "إضافة مضيف ميسكل");
define('enter_mysql_ip', "تفعيل ايبي ميسكل.");
define('enter_valid_port', "أدخل بورت صالح.");
define('enter_mysql_root_password', "أدخل كلمة مرور روت الميسكل.");
define('enter_mysql_name', "أدخل إسم الميسكل.");
define('could_not_add_mysql_server', "تعذر إضافة خادم ميسكل.");
...
define('direct_connection', "اتصال مباشر");
define('connection_through_remote_server_named', "Connection through remote server named %s");
define('add_mysql_server', "إضافة سيرفر ميسكل");
define('mysql_online', "ميسكل متصل");
define('mysql_offline', "ميسكل غير-متصل");
define('encryption_key_mismatch', "عدم تطابق مفتاح التشفير");
define('unknown_error', "خطأ غير معروف");
define('remove', "حذف");
define('assign_db', "تعيين قاعدة البيانات");
define('mysql_server_name', "اسم سيرفر ميسكل");
define('server_status', "حالة السيرفر");
define('mysql_ip_port', "ميسكل أيبي:بورت");
define('mysql_root_passwd', "كلمة مرور روت الميسكل");
