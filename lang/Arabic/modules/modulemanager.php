...
define('not_complete', "ميزة التثبيت / إلغاء التثبيت ليست كاملة وقد لا تعمل بشكل صحيح. تحذير: قد يحدث فقدان البيانات في قاعدة بيانات أوغب!");
...
define('adding_module', "إضافة وحدة تسمى'%s'.");
define('module_already_installed', "الوحدة التي تسمى '%s' مثبتة بالفعل.");
define('uninstalling_module', "إلغاء تثبيت الوحدة '%s'");
define('successfully_uninstalled_module', "تم إلغاء تثبيت الوحدة %s بنجاح.");
