...
define('OGP_LANG_province', "المحافظة");
define('OGP_LANG_country', "البلد");
define('OGP_LANG_comment', "التعليقات");
define('OGP_LANG_expires', "تنتهي في");
define('OGP_LANG_save_profile', "حفظ الملف الشخصي");
define('OGP_LANG_new_password_info', "عندما يكون حقل كلمة المرور فارغًا ، لن يتم تحديث كلمة المرور.");
define('OGP_LANG_theme', "القالب");
define('OGP_LANG_theme_info', "إذا كان السمة فارغة ، يتم استخدام القيمة العامة.");
define('OGP_LANG_expires_info', "تاريخ انتهاء صلاحية حساب المستخدم. لم يتم حذف الحساب ، ولكن لا يمكن للمستخدم تسجيل الدخول بعد الآن.");
define('OGP_LANG_password_mismatch', "كلمتا المرور غير متطابقتين.");
define('OGP_LANG_current_password', "كلمة المرور الحالية");
define('OGP_LANG_current_password_info', "كلمة السر الحالية الخاصة بك.");
define('OGP_LANG_current_password_mismatch', "كلمة المرور الحالية لا تتطابق مع كلمة المرور الموجودة في قاعدة البيانات.");
define('OGP_LANG_add_new_user', "إضافة يوزر جديد");
define('OGP_LANG_edit_user_groups', "تحرير مجموعات المستخدم");
define('OGP_LANG_users', "المستخدمين");
define('OGP_LANG_user_role', "دور المستخدم");
define('OGP_LANG_full_name', "الاسم الكامل");
...
define('OGP_LANG_failed_to_add_group_exists_already', "المجموعة بالاسم %s موجودة بالفعل. يرجى تجربة اسم مجموعة مختلف.");
