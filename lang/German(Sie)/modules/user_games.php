...
define('OGP_LANG_add_mods_note', "Sie müssen Mods hinzufügen, nachdem Sie dem Benutzer einen Server zugewiesen haben. Dies kann durch Bearbeiten des Servers erfolgen.");
...
define('OGP_LANG_no_remote_servers_configured', "Keine Remote-Server für das Open Game Panel konfiguriert.<br>Sie müssen Remote-Server hinzufügen, bevor Sie Server für die Benutzer hinzufügen können.");
define('OGP_LANG_no_game_configurations_found', "Keine Spielkonfiguration gefunden. Sie müssen Spielkonfigurationen aus dem hinzufügen");
...
define('OGP_LANG_game_server_name', "Gameserver Name");
define('OGP_LANG_change_name_info', "Der Name des Servers, damit Benutzer ihn leichter identifizieren können.");
define('OGP_LANG_game_control_password', "Game Control Passwort");
define('OGP_LANG_change_control_password_info', "RCON Passwort - Gameserver Remote Konsole.");
define('OGP_LANG_available_mods', "Verfügbare Mods");
define('OGP_LANG_note_no_mods', "Keine MOD(s) für das Spiel verfügbar.");
...
define('OGP_LANG_extra_cmd_line_info', "Die Extra-Befehlszeilenargumente bieten eine Möglichkeit, zusätzliche Argumente in die Spielbefehlszeile einzugeben, wenn es gestartet wird.");
define('OGP_LANG_cpu_affinity', "CPU-Affinität");
define('OGP_LANG_nice_level', "Nice Level");
define('OGP_LANG_set_options', "Setze Optionen");
define('OGP_LANG_remove_mod', "Mod entfernen");
define('OGP_LANG_mods', "Mods");
define('OGP_LANG_ip', "IP");
define('OGP_LANG_port', "Port");
define('OGP_LANG_no_ip_ports_assigned', "Dem home muss mindestens ein IP:Port-Paar zugewiesen werden.");
define('OGP_LANG_successfully_assigned_ip_port', "Erfolgreich zugewiesene IP:Port zu home.");
define('OGP_LANG_port_range_error', "Der Port muss zwischen 0 und 65535 liegen.");
define('OGP_LANG_failed_to_assing_mod_to_home', "Fehler bei der Zuweisung der MOD mit ID %d zu home.");
...
define('OGP_LANG_back_to_game_servers', "Zurück zu Gameserver");
define('OGP_LANG_user_id_main', "Hauptbesitzer");
define('OGP_LANG_change_user_id_main', "Hauptbesitzer speichern");
define('OGP_LANG_change_user_id_main_info', "Der Hauptbenutzer home Besitzer.");
define('OGP_LANG_server_ftp_password', "FTP Passwort");
define('OGP_LANG_change_ftp_password', "FTP Passwort speichern");
define('OGP_LANG_change_ftp_password_info', "FTP Login Passwort");
define('OGP_LANG_Delete_old_user_assigned_homes', "Heben Sie die Zuweisung von home zu aktuellen Benutzern auf.");
define('OGP_LANG_editing_home_called', "Bearbeite home Pfad");
define('OGP_LANG_control_password_updated_successfully', "RCON Passwort aktualisiert.");
define('OGP_LANG_control_password_update_failed', "RCON Passwort Änderung fehlgeschlagen.");
define('OGP_LANG_successfully_changed_game_server', "Gameserver erfolgreich geändert.");
...
define('OGP_LANG_change_ftp_login', "Ändere FTP Login");
define('OGP_LANG_ftp_login_can_not_be_changed', "Kann FTP Login nicht ändern.");
define('OGP_LANG_server_is_running_change_addresses_not_available', "The server is actually running, the IP cannot be changed.");
define('OGP_LANG_change_game_type', "Ändere Game Type");
...
define('OGP_LANG_game_home', "Home Pfad");
define('OGP_LANG_game_home_name', "Gameserver Name");
...
define('OGP_LANG_allow_updates', "Erlaube Game Updates");
define('OGP_LANG_allow_updates_info', "Erlaube Benutzern das aktualisieren ihres Gameservers.");
define('OGP_LANG_allow_file_management', "Erlaube Datei-Management");
define('OGP_LANG_allow_file_management_info', "Allows user to access the game server with file management modules.");
define('OGP_LANG_allow_parameter_usage', "Erlaube Parameter Nutzung");
...
define('OGP_LANG_game_server_owner', "Gameserver Besitzer");
