...
define('OGP_LANG_start_wait_note', "Der Start des Servers kann eine Weile dauern. Bitte warten Sie, ohne Ihren Browser zu schließen.");
...
");
define('OGP_LANG_if_want_to_start_homes', "Wenn Sie Spieleserver starten wollen, gehen Sie zu %s.");
define('OGP_LANG_view_log', "Log");
define('OGP_LANG_if_want_manage', "Wenn Sie ihre Spiele verwalten möchten, können Sie das in der");
...
define('OGP_LANG_unexpected_result_libremote', "Unerwartetes Ergebnis von libremote, bitte informierem Sie den Entwickler.");
...
define('OGP_LANG_server_already_running', "Server läuft bereits. Wenn Sie den Server nicht im Spielemonitor sehen können, besteht möglicherweise ein Problem, das Sie selbst beheben können.");
...
define('OGP_LANG_before_sending_rcon_com', "bevor Sie rcon Befehle senden.");
...
define('OGP_LANG_jpg_gif_png_less_than_1mb', "Das Bild muss jpg, gif oder png und kleiner als 1 MB sein.");
...
define('OGP_LANG_api_links_popup_html', "<p>Wählen Sie eine Aktion aus, die Sie mit der OGP-API für diesen Spieleserver ausführen möchten. &nbsp; Verwenden Sie dann den unten stehenden Link, um die gewünschte Aktion auszuführen.&nbsp; Sie können Ihre gewünschte Aktion mit einem Cronjob oder einer direkten Anfrage ausführen.</p>");
