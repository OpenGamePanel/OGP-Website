...
define('OGP_LANG_maintenance_mode_info', "Deaktiviert das Panel für Normale Benutzer. Nur <b> Administratoren </b> können während der Wartung darauf zugreifen.");
...
define('OGP_LANG_maintenance_message_info', "Die Meldung, die normalen Benutzern während der Wartung angezeigt wird.");
...
define('OGP_LANG_custom_github_update_branch_name_info', "Geben Sie den Zweignamen ein, den Sie zum Aktualisieren von OGP verwenden möchten. Dies sollte nur von Entwicklern geändert werden, die ihre eigenen Repos für die Entwicklung verwenden möchten, anstatt möglicherweise fehlerhaften Code in den Hauptzweig einzuchecken.&nbsp; Lassen Sie dieses Feld leer, um standardmäßig \"master\" zu verwenden.");
...
define('OGP_LANG_use_authorized_hosts_info', "Aktivieren Sie diese Einstellung, um nur API-Aufrufe von vordefinierten und genehmigten IP-Adressen zuzulassen.&nbsp; Genehmigte Adressen können auf dieser Seite festgelegt werden, sobald die Einstellung aktiviert wurde.&nbsp; Wenn diese Einstellung deaktiviert ist, hat ein Benutzer, der einen gültigen Schlüssel verwendet, von jeder IP-Adresse aus Zugriff auf die API.&nbsp; Benutzer, die einen gültigen Schlüssel verwenden, können die API verwenden, um jeden Spielserver zu verwalten, für dessen Verwaltung sie berechtigt sind.");
define('OGP_LANG_allow_setting_cpu_affinity', "Einstellung der CPU-Kernzuweisung für Gameserver zulassen");
define('OGP_LANG_allow_setting_cpu_affinity_info', "Wenn diese Option aktiviert ist, werden dem Administrator, der ein Game Home erstellt, CPU-Affinitätsoptionen (Kernzuweisung) für den Gameserver angezeigt.");
...
define('OGP_LANG_reset_game_server_order_info', "Setzt die Gameserver-Reihenfolge auf die Standardeinstellung der Server-ID zurück");
define('OGP_LANG_regex_invalid_file_name_chars', "Ungültige Dateinamenzeichen Regex");
define('OGP_LANG_regex_invalid_file_name_chars_info', "Ändern Sie dieses Regex-Muster, wenn Sie einen anderen Zeichensatz in Dateinamen zulassen möchten.");
define('OGP_LANG_login_ban_time', "Zeit für das Bannen fehlerhafter Login versuche (Sekunden)");
define('OGP_LANG_login_ban_time_info', "Zeit in Sekunden, die einer IP-Adresse nach einer definierten Anzahl von fehlgeschlagenen Anmeldeversuchen gesperrt wird, sich am Panel anzumelden.");
?>
