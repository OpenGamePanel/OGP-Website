...
define('OGP_LANG_add_mods_note', "è necessario aggiungere le varie mod dopo aver aggiunto il server. per aggiungere le mod, andare nella pagina di impostazioni del server");
define('OGP_LANG_game_servers', "Server di gioco");
define('OGP_LANG_game_path', "Game Path");
define('OGP_LANG_game_path_info', "Path assoluto del server. Esempio: /home/ogpbot/OGP_User_Files/My_Server");
...
define('OGP_LANG_game_path_empty', "Inserire il Path del gioco");
define('OGP_LANG_game_home_added', "Il server è stato aggiunto, Reindirizzamento alla pagina di configurazione...");
...
define('OGP_LANG_add_remote_server', "Aggiungi un nuovo server");
...
define('OGP_LANG_add_mod', "Aggiungi Mod");
define('OGP_LANG_set_ip', "Imposta IP");
define('OGP_LANG_ips_and_ports', "IPs and Ports");
define('OGP_LANG_mod_name', "Nome Mod");
define('OGP_LANG_max_players', "Numero massimo di giocatori");
...
define('OGP_LANG_remove_mod', "Rimuovi Mod");
