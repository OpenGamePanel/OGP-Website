...
define('OGP_LANG_caution_agent_offline_can_not_get_os_and_arch_showing_servers_for_all_platforms', "<b>Dikkat!</b>Ajan çevrimdışı, işletim sistemi türü ve mimarisi alınamıyor,<br>Tüm platformlar için sunucular gösteriliyor:");
define('OGP_LANG_select_remote_server', "Uzak Sunucuyu Seçin");
define('OGP_LANG_no_remote_servers_configured', "Open Game Panel için yapılandırılmış uzak sunucu yok.<br> Kullanıcılar için sunucularını eklemeden önce uzak sunucu eklemeniz gerekir.");
define('OGP_LANG_no_game_configurations_found', "Oyun yapılandırması bulunamadı. Oyun yapılandırmalarını eklemeniz gerekir.");
define('OGP_LANG_game_configurations', ">oyun yapılandırma sayfası");
define('OGP_LANG_add_remote_server', "Oyun sunucusu ekle");
define('OGP_LANG_wine_games', "Wine Oyunları");
define('OGP_LANG_home_path', "Oyun Konumu");
define('OGP_LANG_change_home_info', "Kurulu oyun sunucusunun konumu. Örnek: /home/ogp/my_server/");
define('OGP_LANG_game_server_name', "Sunucu adı");
define('OGP_LANG_change_name_info', "Kullanıcıların onu tanımasına yardımcı olacak sunucunun adı.");
define('OGP_LANG_game_control_password', "Sunucu şifre");
define('OGP_LANG_change_control_password_info', "Kontrol şifre örneği rcon şifresi içindir.");
define('OGP_LANG_available_mods', "Kullanılabilir modlar");
define('OGP_LANG_note_no_mods', "Bu oyun için uygun mod(lar) yok.");
...
define('OGP_LANG_extra_cmd_line_args', "Ekstra Komut Satırı Argleri");
define('OGP_LANG_extra_cmd_line_info', "Ekstra komut satırı args başlatıldığında oyun komut satırına ekstra argümanlar girmek için bir yol sağlar.");
define('OGP_LANG_cpu_affinity', "CPU Affinitesi");
define('OGP_LANG_nice_level', "Güzel Seviye");
define('OGP_LANG_set_options', "Seçenekleri Ayarla");
define('OGP_LANG_remove_mod', "Eklenti Kaldır");
define('OGP_LANG_mods', "Modlar");
define('OGP_LANG_ip', "IP");
define('OGP_LANG_port', "Port");
define('OGP_LANG_no_ip_ports_assigned', "En az bir IP: Bağlantı noktası çifti eve atanmalıdır.");
define('OGP_LANG_successfully_assigned_ip_port', "IP başarıyla yüklendi: Bağlantı noktası çifti eve.");
define('OGP_LANG_port_range_error', "Bağlantı noktası 0 ile 65535 arasında olmalıdır.");
define('OGP_LANG_failed_to_assing_mod_to_home', "Eve %d kimliğine sahip mod atanamadı.");
define('OGP_LANG_successfully_assigned_mod_to_home', "Eve %dkimliğine sahip mod başarıyla atandı.");
define('OGP_LANG_successfully_modified_mod', "Mod bilgileri başarıyla değiştirildi.");
define('OGP_LANG_back_to_game_monitor', "Oyun Ekranına Geri Dön");
define('OGP_LANG_back_to_game_servers', "Oyun Sunucuları");
define('OGP_LANG_user_id_main', "Ana sahip");
define('OGP_LANG_change_user_id_main', "Ana sahibini değiştir");
define('OGP_LANG_change_user_id_main_info', "Ana sunucu ev sahibi.");
define('OGP_LANG_server_ftp_password', "FTP Şifresi");
define('OGP_LANG_change_ftp_password', "FTP Şifresini değiştir");
define('OGP_LANG_change_ftp_password_info', "Bu ev için FTP sunucusunda oturum açmak için kullanılan paroladır.");
define('OGP_LANG_Delete_old_user_assigned_homes', "Mevcut kullanıcıların atamasını kaldırın.");
define('OGP_LANG_editing_home_called', "Editing home called");
define('OGP_LANG_control_password_updated_successfully', "Kontrol şifresi başarıyla güncellendi.");
define('OGP_LANG_control_password_update_failed', "Kontrol şifresi güncellenemedi");
define('OGP_LANG_successfully_changed_game_server', "Oyun sunucusu başarıyla değiştirildi.");
define('OGP_LANG_error_ocurred_on_remote_server', "Uzak sunucuda hata oluştu,");
define('OGP_LANG_ftp_password_can_not_be_changed', "FTP Şifresin değiştirilemez.");
define('OGP_LANG_ftp_can_not_be_switched_on', "FTP açılamıyor.");
define('OGP_LANG_ftp_can_not_be_switched_off', "FTP kapatılamaz.");
define('OGP_LANG_invalid_home_id_entered', "Geçersiz ev kimliği girildi.");
...
define('OGP_LANG_successfully_removed_mod', "Oyun modu başarıyla kaldırıldı.");
define('OGP_LANG_warning_agent_offline_defaulting_CPU_count_to_1', "Uyarı - Ajan çevrimdışı, varsayılan CPU sayısını 1 olarak ayarlar.");
define('OGP_LANG_mod_install_cmds', "Mod Kurulum CMD'leri");
define('OGP_LANG_cmds_for', "için Komutlar");
define('OGP_LANG_preinstall_cmds', "Ön Yükleme Komutları");
define('OGP_LANG_postinstall_cmds', "Yükleme Sonrası Komutları");
define('OGP_LANG_edit_preinstall_cmds', "Ön Yükleme Komutlarını Düzenle");
define('OGP_LANG_edit_postinstall_cmds', "Yükleme Sonrası Komutlarını Düzenle");
define('OGP_LANG_save_as_default_for_this_mod', "Bu mod için varsayılan olarak kaydet");
define('OGP_LANG_empty', "boş");
define('OGP_LANG_master_server_for_clon_update', "Yerel güncelleme için ana sunucu");
define('OGP_LANG_set_as_master_server', "Ana sunucu olarak ayarla");
define('OGP_LANG_set_as_master_server_for_local_clon_update', "Yerel güncelleme için ana sunucu olarak ayarla.");
...
define('OGP_LANG_change_ftp_account_status', "FTP hesap durumunu değiştir");
define('OGP_LANG_change_ftp_account_status_info', "Bir FTP hesabı etkinleştirildiğinde veya devre dışı bırakıldığında, FTP veritabanına eklenir veya veritabanından kaldırılır.");
define('OGP_LANG_server_ftp_login', "Sunucu FTP Girişi");
define('OGP_LANG_change_ftp_login_info', "FTP Oturum Açma Özelleştirilmiş bir oturum açma ile değiştirin.");
define('OGP_LANG_change_ftp_login', "FTP Girişini Değiştir");
define('OGP_LANG_ftp_login_can_not_be_changed', "FTP Girişi değiştirilemiyor.");
define('OGP_LANG_server_is_running_change_addresses_not_available', "Sunucu çalışıyor, IP değiştirilemiyor.");
define('OGP_LANG_change_game_type', "Oyun Türünü Değiştir");
define('OGP_LANG_change_game_type_info', "Oyun türünü değiştirerek mevcut mods konfigürasyonu silinecektir.");
define('OGP_LANG_force_mod_on_this_address', "Bu adres üzerinde modu zorla");
define('OGP_LANG_successfully_assigned_mod_to_address', "Adrese başarıyla mod atandı");
define('OGP_LANG_switch_mods', "Anahtar modları");
define('OGP_LANG_switch_mod_for_address', "Adres için mod değiştirme %s");
define('OGP_LANG_invalid_path', "Geçersiz Yol");
define('OGP_LANG_add_new_game_home', "Yeni oyun sunucusu ekle");
define('OGP_LANG_no_game_homes_found', "Oyun sunucusu bulunamadı");
define('OGP_LANG_available_game_homes', "Kullanılabilir oyun sunucuları");
define('OGP_LANG_home_id', "Ev Kimliği");
define('OGP_LANG_game_server', "Oyun Sunucusu");
define('OGP_LANG_game_type', "Oyun Türü");
define('OGP_LANG_game_home', "Ev Yolu");
define('OGP_LANG_game_home_name', "Oyun Sunucusu Adı");
define('OGP_LANG_clone', "Klon");
define('OGP_LANG_unassign', "Atamayı Kaldır");
define('OGP_LANG_access_rights', "Erişim Hakları");
define('OGP_LANG_assigned_homes', "Şu Anda Atanan Evler");
define('OGP_LANG_assign', "Ata");
define('OGP_LANG_allow_updates', "Oyun Güncellemelerine İzin Ver");
define('OGP_LANG_allow_updates_info', "Mümkünse kullanıcının oyun kurulumunu güncellemesine izin verir.");
define('OGP_LANG_allow_file_management', "Dosya Yönetimine İzin Ver");
define('OGP_LANG_allow_file_management_info', "Kullanıcının dosya yönetim modülleriyle oyun sunucusuna erişmesine izin verir.");
define('OGP_LANG_allow_parameter_usage', "Parametre Kullanımına İzin Ver");
define('OGP_LANG_allow_parameter_usage_info', "Kullanıcının mevcut komut satırı parametrelerini değiştirmesine izin verir.");
define('OGP_LANG_allow_extra_params', "Ekstra parametrelere izin ver");
define('OGP_LANG_allow_extra_params_info', "Kullanıcının fazladan komut satırı parametrelerini değiştirmesine izin verir.");
define('OGP_LANG_allow_ftp', "FTP'ye izin ver");
define('OGP_LANG_allow_ftp_info', "FTP erişim bilgilerini kullanıcıya gösterin.");
define('OGP_LANG_allow_custom_fields', "Özel Alanlara İzin Ver");
define('OGP_LANG_allow_custom_fields_info', "Kullanıcının varsa oyun sunucusunun özel alanlarına erişmesine izin verir.");
define('OGP_LANG_select_home', "Atamak için Ana Sayfa'yı seçin");
