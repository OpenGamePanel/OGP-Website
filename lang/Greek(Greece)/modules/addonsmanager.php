...
define('OGP_LANG_remove_addon', "Αφαιρέστε Το Πρόσθετο");
...
define('OGP_LANG_addon_name_info', "Βάλετε ένα όνομα για αυτό το πρόσθετο, αυτό είναι το όνομα που βλέπει ο χρήστης.");
define('OGP_LANG_url_info', "Βάλετε μια διεύθυνση ιστού που περιέχει ένα αρχείο για κατέβασμα, αν είναι συμπιεσμένο σε zip ή tar.gz θα αποσυμπιεστεί στον ριζικό κατάλογο του διακομιστή ή στην διαδρομή που δίνεται παρακάτω.");
...
define('OGP_LANG_post-script_info', "Βάλετε κώδικα γλώσσας bash, θα εκτελεστεί σαν δέσμη ενεργειών, μπορείτε να χρησιμοποιήσετε αντικαταστάτες κειμένου για να προσαρμώσετε την εγκατάσταση, θα αντικατασταθούν από δεδομένα από τον διακομιστή στον οποίο εγκαταστήσατε το πρόσθετο. Η δέσμη ενεργειών θα ξεκινήσει από τον ριζικό φάκελο του διακομιστή ή την καθορισμένη διαδρομή.");
?>