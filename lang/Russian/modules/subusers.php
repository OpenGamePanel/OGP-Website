...
define('subuser_password', "Пароль  Суб-пользователя");
define('subuser_man', "Управление Суб-пользователем");
...
define('err_confirm_password', "Пароль для подтверждения не может быть пустым");
...
define('err_users_parent', "Суб-пользователь не может создать других Пользователей.");
define('err_parent_user', "ID родительского пользователя должен ссылаться на действительного, ранее существующего пользователя.");
...
define('subject', "Привет %s и Добро пожаловать %s.");
define('sub_user', "Суб-пользователь");
define('create_sub_user', "Добавить Суб-пользователь");
define('listdel_sub_user', "Просмотр, изменить информацию Суб-пользователя или удалить Суб-пользователя");
define('delete_sub_user', "Изменить / Удалить Суб-пользователь");
define('del_subuser_conf', "Вы уверены что хотите удалить этот Аккаунт:");
define('no_subusers', "Под вашей учетной записью еще не создано Суб-пользователь");
define('subuser_deleted', "Суб-пользователь %sбыл успешно удален из базы данных!");
define('subuser_added', "Суб-пользователь %s был успешно добавлен в базу данных!");
define('your_subusers', "Аккаунт принадлежит Суб-пользователю");
?>