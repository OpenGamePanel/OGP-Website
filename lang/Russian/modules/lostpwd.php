...
define('errormail', "Ваш e-mail адрес неверен.");
define('submit', "Отправить");
define('click', "Нажмите");
define('mail_settings_missing', "Настройки панели не позволяют отправлять e-mail письма. Пожалуйста, свяжитесь с администратором OGP.");
