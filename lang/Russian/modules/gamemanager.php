...
define('OGP_LANG_game_manager', "Менеджер серверов");
...
define('OGP_LANG_no_game_homes_assigned', "У Вашей учетной записи вас нет привязанных серверов. Обратитесь к администратору для решения этой проблемы.");
