...
define('ignored_files', "%sфайлой исключены");
define('not_updated_files_blacklisted', "Не обновляется/Установленные файлы (Черный список): <br>%s");
...
define('files_overwritten', "%sфайлов перезаписано");
...
define('new_files', "%sновых файлов.");
