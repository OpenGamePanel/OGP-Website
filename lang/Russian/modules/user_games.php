...
define('ftp_password_can_not_be_changed', "ФТП пароль не возможно изменить");
define('ftp_can_not_be_switched_on', "ФТП не возможно перевести в режим ON");
define('ftp_can_not_be_switched_off', "ФТП не возможно перевести в режим OFF");
...
define('ftp_on', "Включить ФТП");
define('ftp_off', "Выключить ФТП");
define('change_ftp_account_status', "Изменение статуса ФТП аккаунта");
define('change_ftp_account_status_info', "Как только учетная запись ФТП включена или отключена, Он добавляется или удаляется из базы данных ФТП.");
define('server_ftp_login', "Логин ФТП");
define('change_ftp_login_info', "Измените ФТП логин на свой вписав в поле свой");
define('change_ftp_login', "Изменить ФТП логин");
define('ftp_login_can_not_be_changed', "Невозможно изменить ФТП логин");
...
define('allow_ftp', "Разрешить ФТП");
define('allow_ftp_info', "Показывать информацию о доступе к ФТП пользователю.");
...
define('failed_to_remove_ftp_account_from_remote_server', "Ну удалось удалить ФТП аккаунт из удаленного сервера.");
