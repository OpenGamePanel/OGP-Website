...
define('OGP_LANG_install_plugin', "Установить Плагины");
...
define('OGP_LANG_failed_to_start_file_download', "Не удалось начать загрузку файла.");
define('OGP_LANG_no_games_servers_available', "В вашей учетной записи нет доступных игровых серверов.");
define('OGP_LANG_addon_installed_successfully', "Аддон успешно установлен");
define('OGP_LANG_path', "Путь");
define('OGP_LANG_wait_while_decompressing', "Подождите, пока файл %s будет распакован.");
...
define('OGP_LANG_show_all_addons', "Показать все Аддоны");
define('OGP_LANG_show_addons_for_selected_type', "Показать все Аддоны для выбранного типа");
define('OGP_LANG_show_addons_for_selected_game', "Показать все Аддоны для выбранной игры");
define('OGP_LANG_linux_games', "Linux Игры:");
define('OGP_LANG_windows_games', "Windows Игры:");
define('OGP_LANG_create_addon', "Создать аддон");
define('OGP_LANG_addons_db', "База данных Аддона:");
define('OGP_LANG_addon_has_been_created', "Аддон %s был создан успешно.");
define('OGP_LANG_remove_addon', "Удалить Аддон");
define('OGP_LANG_fill_the_url_address_to_a_compressed_file', "Пожалуйста, заполните URL-адрес сжатого файла. ");
define('OGP_LANG_fill_the_addon_name', "Пожалуйста, введите имя для Аддона.");
