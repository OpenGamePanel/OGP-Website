...
define('refresh_page', "Actualizar Página");
...
define('solve_captcha', "Comprobación de su condición de humano");
define('lost_passwd', "Contraseña perdida?");
...
define('invalid_subpage', "Página subyacente invalida.");
...
define('no', "No");
define('on', "Activado");
define('off', "Desactivado");
define('db_error_invalid_host', "Servidor de base de datos inválido.");
define('db_error_invalid_user_and_pass', "Usuario y contraseña de base de datos inválido.");
...
define('maintenance_mode_on', "La página se desactivo por mantenimiento, disculpen las molestias.");
...
define('lang', "Idioma");
define('get_size', "Mostrar tamaño");
define('total_size', "Tamaño total");
define('lgsl', "LGSL");
define('lgsl_admin', "LGSL Admin");
define('rcon', "RCON");
define('watch_logger', "Ver Registros");
...
define('no_results_found', "No se han encontrado resultados para %s");
define('tickets', "Support Tickets");
define('news', "News");
define('admin_news', "News Admin");
define('rcon', "RCON");
define('support', "Soporte");
define('util', "Utilidades");
