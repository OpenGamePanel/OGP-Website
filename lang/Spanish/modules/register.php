...
define('register_message', "Hola,<br>Tu cuenta ha sido creada.<br><br>Usuario: %s<br>Contraseña: %s<br>Puedes cambiar la contraseña desde tu cuenta.<br>Gracias!<br>El administrador.<br>Esto es un mensaje automático, por favor no respondas!");
define('err_captcha', "Captcha no coincide.");
define('err_login_name', "Nombre de usuario vacío o en uso.");
define('err_first_name', "Introduzca su nombre.");
define('err_last_name', "Introduzca su apellido");
