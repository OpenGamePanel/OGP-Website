...
include 'update.php';
define('unable_download', "Imposible descargar %s.");
define('md5_failed', "Comprobación MD5 falló para %s, intentelo de nuevo mas tarde.");
define('uninstall', "Desinstalar");
define('install', "Instalar");
define('uptodate', "Actualizado");
define('update_available', "Actualización disponible");
