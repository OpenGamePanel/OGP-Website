...
define('remote_host_port_info', "El puerto que es escuchado por el Agente de OGP en el host remoto. Defecto: 12679.");
...
define('note_remote_host', "Un host remoto es un servidor donde se está ejecutando el agente OGP. Cada host puede tener varias direcciones IP en las que los usuarios pueden enlazar servidores.");
...
define('remote_host_ftp_ip_info', "El servidor FTP <b>IP</b> para el Agente actual.");
define('remote_host_ftp_port', "Puerta FTP");
define('remote_host_ftp_port_info', "El servidor FTP  <b>puerta</b> es el Agente actual.");
...
define('confirm_restart', "Está seguro de que desea reiniciar el agente denominado '%s'?");
define('restarting', "Agente de reinicio ... Espere.");
...
define('areyousure_removeagent', "¿Seguro que desea eliminar el Agente llamado");
...
define('timeout_info', "El límite de tiempo en segundos para obtener respuesta de este agente.");
...
define('default_allowed', "Se permite por defecto");
...
define('display_public_ip', "Mostrar IP Público");
?>