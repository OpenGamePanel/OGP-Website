...
define('password_message', "Hola,<br>Su contraseña ha sido modificada.<br>Nueva contraseña: %s<br>Puede volver a cambiarla desde su cuenta.<br>Gracias!<br>El administrador.<br>Esto es un mensaje automático, por favor no responda.");
define('send', "<b style='color:red;'>Su contraseña ha sido enviada! Por favor compruebe su bandeja de entrada.</b>");
define('here', "Aquí");
define('to_login', "para entrar");
define('errormail', "La dirección de correo electronico no es valida.");
...
define('enter_email', "Introduzca su dirección de correo electronico");
