...
define('game_home', "Camino de inicio");
...
define('view_log', "Visor de registro");
...
define('update_from_local_master_server', "Actualización desde el servidor maestro local");
...
define('auto_update_copy_me_fail', "Error al copiar. Por favor, copie manualmente el enlace.");
...
define('cannot_update_from_own_self', "La actualización del servidor local puede no ejecutarse en un servidor maestro.");
