...
define('panel_name_info', "Nombre del Panel que se muestra en el título de la página. Este valor invalidará todos los títulos de las páginas, si no está vacío.");
define('feed_enable', "Activar Feed LGSL");
define('feed_enable_info', "Si su webhost tiene un firewall que está bloqueando el puerto de consulta, entonces usted necesita para abrir el puerto manualmente.");
...
define('custom_github_update_username', "Nombre de usuario de GitHub update");
...
define('custom_tab_target_blank_info', "Establece todas las pestañas de destino. <b style='font-size:10px; font-weight:normal;'>(Self_Page = Abre el enlace en la misma página. New_Page  =  Abre el enlace en la pestaña nueva.)</b>");
...
define('show_server_id_game_monitor', "Mostrar ID de servidor en la página de Monitor de juegos");
define('show_server_id_game_monitor_info', "Muestra la columna ID del servidor de juegos en el Monitor de juegos para buscar los archivos creados por el Agente en el servidor de juego real.");
