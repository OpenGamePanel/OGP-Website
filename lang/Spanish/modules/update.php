...
define('files_not_overwritten', "%s Archivos NO sobrescritos debido a la lista negra.");
...
define('temp_folder_not_writable', "No se puede colocar la descarga, debido a que Apache no tiene permisos de escritura en la carpeta temporal del sistema(%s).");
