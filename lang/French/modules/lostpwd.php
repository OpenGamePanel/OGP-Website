...
define('password_message', "Bonjour,<br><br>Vous ou quelqu'un d'autre a réinitialisé votre mot de passe.<br><br>Nouveau mot de passe: %s<br><br>Pensez à changer régulièrement votre mot de passe.<br><br>Ceci est un message automatisé, n'y répondez pas !<br><br>______________________________<br>Merci, l'Administrateur");
define('send', "Votre mot de passe a été envoyé! Veuillez vérifier votre e-mail!");
define('here', "ici");
