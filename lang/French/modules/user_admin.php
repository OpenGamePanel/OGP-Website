...
define('page_limit', "Objets par page");
define('page_limit_info', "Nombre d&apos;objets par page. Ce nombre ne peut pas être inférieur à 10.");
...
define('current_password_mismatch', "Votre mot de passe actuel ne correspond pas avec celui de la base de données.");
...
define('user_role', "Rôle de l'utilisateur");
...
define('profile_of_user_modified_successfully', "Le profil de l'utilisateur <b>%s</b> a été modifié avec succès.");
...
define('andSubUsers', " Et tous ses Utilisateurs Secondaires ?");
define('subusers', "Utilisateurs Secondaires");
define('show_subusers', "Montrer les Utilisateurs Secondaires");
define('hide_subusers', "Cacher les Utilisateurs Secondaires");
define('info_group', "Sur cette page il est possible de gérer les Groupes d'Utilisateurs. Vous pouvez assigner un Serveur à un Groupe pour qu'il soit accessible par tout le Groupe.");
...
define('editing_profile', "Edition du profil: %s");
define('valid_user', "Veuillez spécifier un utilisateur valide.");
define('enter_valid_username', "Veuillez entrer un nom d'utilisateur valide.");
define('unexpected_role', "Rôle d'utilisateur reçu inattendu.");
