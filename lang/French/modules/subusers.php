...
define('err_parent_user', "L'ID de l'utilisateur parent doit être l'ID d'un utilisateur valide.");
...
define('your_subusers', "Mes Utilisateurs Secondaires");
?>