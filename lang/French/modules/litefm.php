...
define('dir_not_found', "Dossier '%s' introuvable sur le serveur.");
...
define('chattr_locked', "Fichier verrouillé");
define('chattr_unlocked', "Fichier déverrouillé");
...
define('to', "Vers");
define('upload_to_web', "Envoi sur le serveur web");
define('transfer_to_server', "Transfère vers le serveur");
