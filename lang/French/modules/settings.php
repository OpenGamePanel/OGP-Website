...
define('query_num_servers_stop', "Désactiver Interrogation du Serveur de Jeu après");
...
define('recaptcha_use_login_info', "Si activé, l'utilisateur devra résoudre le Recaptcha Pas Un Robot lors de l'authentification.");
...
define('check_expiry_by_info', "Si mis sur once_logged_in, l'attribution de serveur de jeu de l'utilisateur sera automatiquement supprimée si la date d'expiration est dépassée. Si mis sur cron_job, vous devrez créer une tâchr cron  en utilisant le module cron pour vérifier la date d'expiration à un interval déterminé.");
