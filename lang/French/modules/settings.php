...
define('feed_enable_info', "Si votre hébergement web a un pare-feu (firewall) bloquant les requêtes sur les ports, vous devez ouvrir le port manuellement.");
...
define('default_game_server_home_path_prefix_info', "Entrer le chemin vers lequel vous voulez que les dossiers des serveurs de jeu soient créés par défaut. Vous pouvez utiliser \"{USERNAME}\" dans le chemin, qui sera remplacé par le nom d'utilisateur OGP pour lequel le serveur sera assigné. Exemple: /ogp/games/{USERNAME} deviendra /ogp/games/username/1 où 1 sera l&aposID des serveurs de jeu. Exemple 2: /ogp/games deviendra /ogp/games/1 où 1 sera l&aposID des serveurs de jeu.");
?>
