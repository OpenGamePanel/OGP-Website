...
define('ports_range_added_successfull_for', "Ports range added successful for %s.");
define('ports_range_deleted_successfull', "Ports range deleted successful.");
define('ports_range_edited_successfull_for', "Ports range edited successful for %s.");
