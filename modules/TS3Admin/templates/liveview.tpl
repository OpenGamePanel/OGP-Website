			...
			<div id="serverview_client_{$serverTree[tree].clients[client].clid}" class="{cycle values="table2,table1"}">
				<span style="float:right;">
					<span class="serverview_client">
						<a href="javascript:setUserMoveToChan({$serverTree[tree].clients[client].clid});"><img src="modules/TS3Admin/images/viewer/rarrow.png" class="viewer" border="0" title="{$lang.vsliveview_liveview_tooltip_switch}" /></a>
						<a href="javascript:sendMsg({$serverTree[tree].clients[client].clid}, 1);"><img src="modules/TS3Admin/images/viewer/16x16_player_chat.png" class="viewer" border="0" title="{$lang.vsliveview_liveview_tooltip_send_msg}" /></a>
						<a href="javascript:poke({$serverTree[tree].clients[client].clid});"><img src="modules/TS3Admin/images/viewer/16x16_poke.png" class="viewer" border="0" title="{$lang.vsliveview_liveview_tooltip_poke}" /></a>
						<a href="javascript:kickClient({$serverTree[tree].clients[client].clid});"><img src="modules/TS3Admin/images/viewer/16x16_delete.png" width="16" height="16" class="viewer" border="0" title="{$lang.vsliveview_liveview_tooltip_kick}" /></a>
						<a href="javascript:banClient({$serverTree[tree].clients[client].clid});"><img src="modules/TS3Admin/images/viewer/16x16_ban_client.png" width="16" height="16" class="viewer" border="0" title="{$lang.vsliveview_liveview_tooltip_ban}" /></a>
					</span>
